...
public class GCYMComputationRecipeLogic extends GCYMMultiblockRecipeLogic {
    ...
    public GCYMComputationRecipeLogic(RecipeMapMultiblockController metaTileEntity, ComputationType type) {
