...
public class GTQTMaterials {
    ...
    public static Material ZincOxideFlashMixture;
    public static Material RichZincFlashMixture;
    public static Material EnrichmentResidualFlashZincRoasting;
    public static Material ZincFlashSolution;
    public static Material FerricHydroxide;
    public static Material MixedGermaniumIronResidue;
    public static Material MixedGermaniumCadmiumResidue;
    public static Material GermaniumMonoxide;
    public static Material BurningGermaniumSlag;
    public static Material EnrichedGermaniumPrecipitation;
    public static Material HighPurityGermaniumTetrachloride;
    public static Material HighPurityGermaniumDioxide;
    public static Material ResidueSolution;
    public static Material TannicAcid;
    public static Material Fujizhechendian;
    public static Material EnrichedGermaniumPrecipitationAcid;
    public static Material ImpureTannicAcid;
