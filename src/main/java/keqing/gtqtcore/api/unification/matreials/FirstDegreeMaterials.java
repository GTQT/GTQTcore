...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        GTQTMaterials.StellarMaterialResidueA = (new Material.Builder(20004, GTUtility.gregtechId("stellar_material_residue_a"))).plasma().color(14601000).build().setFormula("ST-α", true);
        GTQTMaterials.StellarMaterialResidueB = (new Material.Builder(20005, GTUtility.gregtechId("stellar_material_residue_b"))).plasma().color(14600000).build().setFormula("ST-β", true);
        GTQTMaterials.StellarMaterialResidueC = (new Material.Builder(20006, GTUtility.gregtechId("stellar_material_residue_c"))).plasma().color(14639000).build().setFormula("ST-γ", true);
        GTQTMaterials.StellarMaterial = (new Material.Builder(20007, GTUtility.gregtechId("stellar_material"))).plasma().color(14638000).build().setFormula("ST-ST", true);
        ...
        GTQTMaterials.MagnetoHydrodynamicallyConstrainedStarMatter = new Material.Builder(20011, gregtechId("magneto_hydrodynamically_constrained_star_matter"))
                .ingot()
                .fluid()
                .fluidPipeProperties(60000000,1000,false)
