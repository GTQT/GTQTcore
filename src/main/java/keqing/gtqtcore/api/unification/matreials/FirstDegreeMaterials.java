...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        GTQTMaterials.Pyrotheum = (new Material.Builder(getMaterialsId(), gtqtcoreId("pyrotheum"))).fluid().color(14601000).build();
        ...
        GTQTMaterials.Alumite = new Material.Builder(getMaterialsId(), gtqtcoreId("alumite"))
                .fluid()
                .ingot()
                .color(0x607186)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.CopperCl = new Material.Builder(getMaterialsId(), gtqtcoreId("copper_cl"))
                .ingot()
                .color(0x8B4C39)
                .iconSet(METALLIC)
                .flags(GENERATE_FOIL)
        ...
        //氧化铪-氧化锆混合物
        GTQTMaterials.HafniumOxideZirconiumOxideMixture = new Material.Builder(getMaterialsId(), gtqtcoreId("hafnium_oxide_zirconium_oxid_mixture"))
                .dust()
        ...
        //氧化铪
        GTQTMaterials.HafniumOxide = new Material.Builder(getMaterialsId(), gtqtcoreId("hafnium_oxide"))
                .dust()
                .color(0xd89045).iconSet(SHINY)
        ...
        //四氯化铪_锆
        GTQTMaterials.HafniumZirconiumTetrachloride = new Material.Builder(getMaterialsId(), gtqtcoreId("hafnium_zirconium_tetrachloride"))
                .fluid()
        ...
        //低纯
        GTQTMaterials.LowPurityHafniumZirconiumResidue = new Material.Builder(getMaterialsId(), gtqtcoreId("low_purity_hafnium_zirconium_residue"))
                .dust()
        ...
        //低纯碘化
        GTQTMaterials.LowPurityHafniumZirconiumIodideMixture = new Material.Builder(getMaterialsId(), gtqtcoreId("low_purity_hafnium_zirconium_iodide_mixture"))
                .fluid()
        ...
        //杀虫剂
        GTQTMaterials.Dfeltamethrin = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrin"))
                .fluid()
                .color(0x0000EE)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //溴氰菊酯
        GTQTMaterials.Deltamethrin = new Material.Builder(getMaterialsId(), gtqtcoreId("deltamethrin"))
                .dust()
        ...
        //二溴水苯
        GTQTMaterials.Dfeltamethrina = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrina"))
                .fluid()
                .color(0x006400)
                .flags(DISABLE_DECOMPOSITION)
                .components(Carbon, 22, Hydrogen, 19, Bromine, 2, Nitrogen, 1, Oxygen, 3)
        ...
        //二溴苯酚
        GTQTMaterials.Dfeltamethrinb = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrinb"))
                .fluid()
                .color(0x00688B)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //二溴-2-丙酮酚
        GTQTMaterials.Dfeltamethrinc = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrinc"))
                .fluid()
                .color(0x00868B)
                .flags(DISABLE_DECOMPOSITION)
                .build()
                .setFormula("C6H4Br2O", true);
        //二溴-2-丙酮酚盐酸盐
        GTQTMaterials.Dfeltamethrind = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrind"))
                .fluid()
                .color(0x008B00)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //二溴菊酸
        GTQTMaterials.Dfeltamethrine = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrine"))
                .fluid()
                .color(0x008B45)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //二溴菊酰氯
        GTQTMaterials.Dfeltamethrinf = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrinf"))
                .fluid()
                .color(0x008B8B)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //间苯氧基苯甲醛
        GTQTMaterials.Dfeltamethring = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethring"))
                .fluid()
                .color(0x009ACD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //α-氰基间苯氧基苯甲醇
        GTQTMaterials.Dfeltamethrinh = new Material.Builder(getMaterialsId(), gtqtcoreId("dfeltamethrinh"))
                .fluid()
                .color(0x00B2EE)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        //净化水产线
        GTQTMaterials.CleanWater_1 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_1"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_2 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_2"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_3 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_3"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_4 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_4"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_5 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_5"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_6 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_6"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_7 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_7"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.CleanWater_8 = new Material.Builder(getMaterialsId(), gtqtcoreId("clean_water_8"))
                .fluid()
                .color(0x1874CD)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.Birmabright = new Material.Builder(25000, gtqtcoreId("birmabright"))
                .ingot()
                .fluid()
                .blast(1100)
        ...
        GTQTMaterials.BT6 = new Material.Builder(25001, gtqtcoreId("bt_6"))
                .ingot()
                .fluid()
        ...
        GTQTMaterials.TriphenylPhosphine = new Material.Builder(25002, gtqtcoreId("triphenylphosphine"))
                .dust()
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Difluorobenzophenone = new Material.Builder(25003, gtqtcoreId("difluorobenzophenone"))
                .dust()
                .color(0xC44DA5)
                .iconSet(SHINY)
        ...
        GTQTMaterials.MolybdenumSulfide = new Material.Builder(25004, gtqtcoreId("molybdenumsulfide"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.PhenylmagnesiumBromide = new Material.Builder(25005, gtqtcoreId("phenylmagnesiumbromide"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Bromobenzene = new Material.Builder(25006, gtqtcoreId("bromobenzene"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Draconium = new Material.Builder(25007, gtqtcoreId("draconium"))
                .ingot().fluid()
                .color(0x573d85).iconSet(MaterialIconSet.DULL)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .build();

        GTQTMaterials.SilicaCeramic = new Material.Builder(25008, gtqtcoreId("silicaceramic"))
                .ingot()
                .blast(1000)
        ...
        GTQTMaterials.NickelPlatedTin = new Material.Builder(25009, gtqtcoreId("nickelplatedtin"))
                .ingot()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.HydrogenSilsesquioxane = new Material.Builder(25012, gtqtcoreId("hydrogensilsesquioxane"))
                .fluid()
                .color(0x471525)
                .build()
        ...
        GTQTMaterials.SU8_Photoresist = new Material.Builder(25013, gtqtcoreId("su_photoresist"))
                .fluid()
                .color(0x0e242b)
                .build();
        GTQTMaterials.Fiberglass = new Material.Builder(25014, gtqtcoreId("fiberglass"))
                .ingot().fluid()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .color(0x99c0cf)
                .build();

        GTQTMaterials.LuminescentSiliconNanocrystals = new Material.Builder(25015, gtqtcoreId("luminescentsiliconnanocrystals"))
                .dust()
                .iconSet(MaterialIconSet.SHINY)
                .color(0x363636)
                .build();

        GTQTMaterials.SeleniumMonobromide = new Material.Builder(25016, gtqtcoreId("seleniummonobromide"))
                .fluid()
                .color(0x472a1a)
                .build();

        //  25038 Hydroquinone
        GTQTMaterials.Hydroquinone = new Material.Builder(25017, gtqtcoreId("hydroquinone"))
                .fluid()
                .color(0x83251A)
        ...
        GTQTMaterials.Fluorobenzene = new Material.Builder(25018, gtqtcoreId("fluorobenzene"))
                .fluid()
                .color(0x7CCA88)
                .components(Carbon, 6, Hydrogen, 5, Fluorine, 1)
                .build();

        GTQTMaterials.Starlight = new Material.Builder(25019, gtqtcoreId("starlight"))
                .fluid()
                .color(0xebfafc)
                .iconSet(MaterialIconSet.SHINY)
                .build();

        GTQTMaterials.SilverLeadOxide = new Material.Builder(25020, gtqtcoreId("silverleadoxide"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.PalladiumChloride = new Material.Builder(25021, gtqtcoreId("palladiumchloride"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.TetrakisPDCatalyst = new Material.Builder(25022, gtqtcoreId("tretrakispdcatalyst"))
                .dust()
                .color(0x9bd1e8)
                .iconSet(MaterialIconSet.SHINY)
                .build();

        GTQTMaterials.HydraziniumChloride = new Material.Builder(25023, gtqtcoreId("hydraziniumchloride"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.DibromoisophthalicAcid = new Material.Builder(25024, gtqtcoreId("dibromoisophthalicacid"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Dibromoterephthaloyldichloride = new Material.Builder(25025, gtqtcoreId("dibromoterephthaloyldichloride"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.P1Solution = new Material.Builder(25026, gtqtcoreId("p_one_solution"))
                .fluid()
                .color(0x6b0c05)
                .build();

        GTQTMaterials.HafniumSilicate = new Material.Builder(25027, gtqtcoreId("hafnium_silicate"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.Cobalt60 = new Material.Builder(25028, gtqtcoreId("cobalt_sixty"))
                .dust()
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.Fluorotoluene = new Material.Builder(25029, gtqtcoreId("fluorotoluene"))
                .fluid()
                .color(0x6EC5B8)
                .components(Carbon, 7, Hydrogen, 7, Fluorine, 1)
                .build();

        GTQTMaterials.Resorcinol = new Material.Builder(25030, gtqtcoreId("resorcinol"))
                .fluid()
                .color(0x9DA38D)
                .components(Carbon, 6, Hydrogen, 6, Oxygen, 2)
                .build();

        GTQTMaterials.ZnFeAlClCatalyst = new Material.Builder(25031, gtqtcoreId("zn_fe_al_cl_catalyst"))
                .dust()
                .color(0xC522A9)
                .iconSet(DULL)
        ...
        GTQTMaterials.NitrileButadieneRubber = new Material.Builder(25032, gtqtcoreId("nitrile_butadiene_rubber"))
                .fluid()
                .color(0x211A18)
        ...
        GTQTMaterials.PolyPhosphonitrileFluoroRubber = new Material.Builder(25033, gtqtcoreId("poly_phosphonitrile_fluoro_rubber"))
                .fluid()
                .color(0x372B28)
                .flags(DISABLE_DECOMPOSITION, GENERATE_PLATE, GENERATE_RING)
        ...
        GTQTMaterials.DichIorosilane = new Material.Builder(25043, gtqtcoreId("dich_iorosilane"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Silane = new Material.Builder(25045, gtqtcoreId("silane"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.ArgonSilane = new Material.Builder(25044, gtqtcoreId("argon_silane"))
                .gas().plasma()
                .components(Argon, 1, GTQTMaterials.Silane, 1)
                .color(0x24BB18)
                .build();

        GTQTMaterials.CarbonNanotubePolymer = new Material.Builder(25046, gtqtcoreId("carbon_nanotube_polymer"))
                .dust()
                .ingot()
                .color(0x0d0d0d)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.NihoniumTriiodide = new Material.Builder(25048, gtqtcoreId("nihonium_triiodide"))
                .dust()
                .ingot()
                .color(0x5986a8)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.Gluons = new Material.Builder(25051, gtqtcoreId("gluons"))
                .fluid()
                .color(0xffffff)
                .build();

        GTQTMaterials.LightQuarks = new Material.Builder(25052, gtqtcoreId("light_quarks"))
                .fluid()
                .color(0x59ff7d)
                .build();

        GTQTMaterials.HeavyQuarks = new Material.Builder(25053, gtqtcoreId("heavy_quarks"))
                .fluid()
                .color(0x4a080b)
                .build();

        GTQTMaterials.BismuthTelluride = new Material.Builder(25054, gtqtcoreId("bismuth_telluride"))
                .ingot()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .colorAverage()
        ...
        GTQTMaterials.SynthDiamond = new Material.Builder(25055, gtqtcoreId("synthetic_diamond"))
                .dust()
                .gem()
                .color(0x8fbaff)
                .components(Carbon, 8)
        ...
        GTQTMaterials.GraphenePQD = new Material.Builder(25056, gtqtcoreId("photoluminescent_graphene_quantum_dots"))
                .dust()
                .color(0x616161)
                .iconSet(MaterialIconSet.SHINY)
                .components(Carbon, 6)
        ...
        GTQTMaterials.HeavyQuarkDegenerate = new Material.Builder(25057, gtqtcoreId("heavy_quark_degenerate_matter"))
                .fluid()
                .ingot()
                .color(0x171717)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .components(GTQTMaterials.Gluons, 1, GTQTMaterials.HeavyQuarks, 4, GTQTMaterials.LightQuarks, 1)
                .build();

        GTQTMaterials.BismuthIridiumOxide = new Material.Builder(25058, gtqtcoreId("bismuth_iridium_oxide"))
                .ingot()
                .colorAverage()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.IndiumFluoride = new Material.Builder(25059, gtqtcoreId("indium_fluoride"))
                .fluid()
                .color(0x2d5c53)
                .components(Indium, 1, Fluorine, 3)
                .build();

        GTQTMaterials.EnrichedNaqAlloy = new Material.Builder(25060, gtqtcoreId("enriched_naquadah_alloy"))
                .ingot()
                .fluid()
                .colorAverage()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.SodiumPotassiumNiobate = new Material.Builder(25061, gtqtcoreId("sodium_potassium_niobate"))
                .ingot()
                .colorAverage()
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.TriniumSteel = new Material.Builder(25062, gtqtcoreId("trinium_steel"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .blast(10200)
                .colorAverage()
        ...
        GTQTMaterials.XenonFluorideSupercondiveMix = new Material.Builder(25064, gtqtcoreId("xenon_fluoride_mix"))
                .fluid()
                .color(0x251a33)
                .build();


        GTQTMaterials.XenonOxyTetraFluoride = new Material.Builder(25065, gtqtcoreId("xenon_oxytetrafluoride"))
                .fluid()
                .colorAverage()
                .components(Xenon, 1, Oxygen, 1, Fluorine, 4)
                .build();

        GTQTMaterials.XenonDioxide = new Material.Builder(25066, gtqtcoreId("xenon_dioxide"))
                .fluid()
                .colorAverage()
                .components(Xenon, 1, Oxygen, 2)
                .build();

        GTQTMaterials.XenonTetraFluoride = new Material.Builder(25067, gtqtcoreId("xenon_tetrafluoride"))
                .fluid()
                .color(0x3d1e42)
                .components(Xenon, 1, Fluorine, 4)
                .build();
        GTQTMaterials.XenonHexaFluoride = new Material.Builder(25068, gtqtcoreId("xenon_hexafluoride"))
                .fluid()
                .color(0x8d5cff)
                .components(Xenon, 1, Fluorine, 6)
                .build();

        GTQTMaterials.TerfenolD_H = new Material.Builder(25069, gtqtcoreId("terfenol_d_heavy"))
                .ingot()
                .blast(10200)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.TerfenolD_L = new Material.Builder(25070, gtqtcoreId("terfenol_d_light"))
                .ingot()
                .blast(10200)
                .color(0x9c9c9c)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.SuspendedPGQD = new Material.Builder(25071, gtqtcoreId("suspended_pgqd"))
                .fluid()
                .color(0x65ad95)
                .components(Krypton, 1, GTQTMaterials.GraphenePQD, 1)
                .build();

        GTQTMaterials.Leptons = new Material.Builder(25072, gtqtcoreId("leptons"))
                .fluid()
                .color(0x5500ff)
                .build();

        GTQTMaterials.NeonFluoride = new Material.Builder(25073, gtqtcoreId("neon_fluoride"))
                .fluid()
                .colorAverage()
                .components(Neon, 1, Fluorine, 1)
                .build();

        GTQTMaterials.ExcitedNeonFluoride = new Material.Builder(25074, gtqtcoreId("excited_neon_fluoride"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.ArgonFluorine = new Material.Builder(25075, gtqtcoreId("argon_fluorine"))
                .fluid()
                .color(0x00ff88)
                .components(Argon, 1, Fluorine, 1)
                .build();

        GTQTMaterials.SilverGalliumSelenide = new Material.Builder(25076, gtqtcoreId("silver_gallium_selenide"))
                .dust()
                .colorAverage()
                .components(Silver, 1, Gallium, 1, Selenium, 2)
                .build();

        GTQTMaterials.BismuthPhosphomolybdate = new Material.Builder(25077, gtqtcoreId("bismuth_phosphomolybdate"))
                .dust()
                .colorAverage()
                .components(Bismuth, 9, Phosphorus, 1, Molybdenum, 12, Oxygen, 52)
                .build();

        GTQTMaterials.Acrylonitrile = new Material.Builder(25078, gtqtcoreId("acrylonitrile"))
                .fluid()
                .color(0x565734)
        ...
        GTQTMaterials.Polyacrylonitrile = new Material.Builder(25081, gtqtcoreId("polyacrylonitrile"))
                .dust()
                .color(0x854218)
                .build();

        GTQTMaterials.CFCoatingSolution = new Material.Builder(25082, gtqtcoreId("cf_coating_solution"))
                .fluid()
                .colorAverage()
                .components(PolyvinylChloride, 1, Polyethylene, 1)
                .build();

        GTQTMaterials.Polyetheretherketone = new Material.Builder(25086, gtqtcoreId("peek"))
                .ingot().fluid()
                .iconSet(MaterialIconSet.DULL)
                .color(0x2b2b2b)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.ProgrammableMatter = new Material.Builder(25087, gtqtcoreId("programmable_matter"))
                .ingot()
                .fluid()
                .color(0x8196a3)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.LutetiumTantalate = new Material.Builder(25088, gtqtcoreId("lutetium_tantalite"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.Iridrhodruthenium = new Material.Builder(25089, gtqtcoreId("iridrhodruthenium"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.HEA_1 = new Material.Builder(25090, gtqtcoreId("high_entropy_alloy_1"))
                .ingot()
        ...
        GTQTMaterials.HEA_2 = new Material.Builder(25091, gtqtcoreId("high_entropy_alloy_2"))
                .ingot()
                .fluid()
                .iconSet(MaterialIconSet.METALLIC)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.HEA_3 = new Material.Builder(25092, gtqtcoreId("high_entropy_alloy_3"))
                .ingot()
                .fluid()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.HDCS_1 = new Material.Builder(25093, gtqtcoreId("high_durability_compound_steel_1"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .color(0x2e216e)
        ...
        GTQTMaterials.HDCS_2 = new Material.Builder(25094, gtqtcoreId("high_durability_compound_steel_2"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .color(0x3d0b0e)
        ...
        GTQTMaterials.HDCS_3 = new Material.Builder(25095, gtqtcoreId("high_durability_compound_steel_3"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .color(0x1f0126)
        ...
        GTQTMaterials.Pikyonium = new Material.Builder(25096, gtqtcoreId("pikyonium"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .color(0x3770bf)
                .blast(b -> b
        ...
        GTQTMaterials.HafniumCarbide = new Material.Builder(25097, gtqtcoreId("hafnium_carbide"))
                .dust()
                .iconSet(MaterialIconSet.METALLIC)
                .colorAverage()
        ...
        GTQTMaterials.SeaborgiumCarbide = new Material.Builder(25099, gtqtcoreId("seaborgium_carbide"))
                .dust()
                .iconSet(MaterialIconSet.METALLIC)
                .colorAverage()
        ...
        GTQTMaterials.TantalumHafniumSeaborgiumCarbide = new Material.Builder(25100, gtqtcoreId("tantalum_hafnium_seaborgium_carbide"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .colorAverage()
        ...
        GTQTMaterials.TantalumHafniumSeaborgiumCarboNitride = new Material.Builder(25101, gtqtcoreId("tantalum_hafnium_seaborgium_carbonitide"))
                .ingot()
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
                .color(0x1c1c1c)
        ...
        GTQTMaterials.Methyltrichlorosilane = new Material.Builder(25103, gtqtcoreId("methyltrichlorosilane"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Methyltrimethoxysilane = new Material.Builder(25104, gtqtcoreId("methyltrimethyoxysilane"))
                .fluid()
                .color(0x42163c)
        ...
        GTQTMaterials.Polymethylsilesquioxane = new Material.Builder(25105, gtqtcoreId("polymethylsilesquioxane"))
                .fluid()
                .color(0xff7ab4)
                .components(Silicon, 1, Oxygen, 3, Carbon, 4, Hydrogen, 12)
                .build()
        ...
        GTQTMaterials.IridiumOnCubicZirconia = new Material.Builder(25107, gtqtcoreId("iridiumoncubiczirconia"))
                .dust()
                .colorAverage()
                .build();

        GTQTMaterials.OnePropanol = new Material.Builder(25108, gtqtcoreId("onepropanol"))
                .fluid()
                .color(0xbad17b)
        ...
        GTQTMaterials.ZSM_5_ZEOLITE = new Material.Builder(25109, gtqtcoreId("zsm_five_zeolite"))
                .dust()
                .color(0xb8ffe1)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.SodiumHydroxideSilica = new Material.Builder(25110, gtqtcoreId("sodiumhydroxidesilica"))
                .fluid()
                .color(0x213996)
        ...
        GTQTMaterials.SodiumAluminate = new Material.Builder(25111, gtqtcoreId("sodiumaluminate"))
                .dust()
                .colorAverage()
                .components(Sodium, 1, Aluminium, 1, Oxygen, 2)
                .build();

        GTQTMaterials.SodiumAluminumSilicaSolution = new Material.Builder(25112, gtqtcoreId("aluminumsilicasolution"))
                .fluid()
                .color(0xb0c1ff)
                .components(Sodium, 1, Aluminium, 1, Silicon, 1, Oxygen, 2, Water, 1)
                .build();

        GTQTMaterials.AluminoSilicateGlass = new Material.Builder(25113, gtqtcoreId("aluminosilicateglass"))
                .ingot()
                .flags(GENERATE_PLATE)
                .color(0x9a9fb3)
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LONG_ROD, GENERATE_FOIL, GENERATE_RING, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_SMALL_GEAR, GENERATE_FINE_WIRE, GENERATE_ROTOR, GENERATE_ROUND)
        ...
        GTQTMaterials.TetramethylammoniumBromide = new Material.Builder(25116, gtqtcoreId("tetramethylammoniumbromide"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.DiamondSonicationSolution = new Material.Builder(25117, gtqtcoreId("diamondsonicationsolution"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SuperfluidHelium3 = new Material.Builder(25118, gtqtcoreId("superfluidhelium"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.CobaltChloride = new Material.Builder(25119, gtqtcoreId("cobaltchloride"))
                .fluid()
                .color(0x48559F)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.CobaltIodide = new Material.Builder(25120, gtqtcoreId("cobaltiodide"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
                .build();

        GTQTMaterials.Cobalt59 = new Material.Builder(25121, gtqtcoreId("cobalt_59"))
                .dust()
                .color(0x3D3DFA)
                .build()
                .setFormula("Co-59", false);

        GTQTMaterials.Cobalt59Iodide = new Material.Builder(25122, gtqtcoreId("cobalt_59_iodide"))
                .fluid()
                .color(0x0B0058)
                .build();

        GTQTMaterials.Cobalt60Iodide = new Material.Builder(25123, gtqtcoreId("cobalt_60_iodide"))
                .fluid()
                .colorAverage()
                .build();

        GTQTMaterials.HydroiodicAcid = new Material.Builder(25124, gtqtcoreId("hydroiodicacid"))
                .fluid()
                .colorAverage()
                .build();

        GTQTMaterials.ImpureHydroiodicAcid = new Material.Builder(25125, gtqtcoreId("impurehydroiodicacid"))
                .fluid()
                .colorAverage()
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Butynediol = new Material.Builder(25126, gtqtcoreId("butynediol"))
                .fluid()
                .colorAverage()
                .components(Carbon, 4, Hydrogen, 6, Oxygen, 2)
                .build();

        GTQTMaterials.KAOil = new Material.Builder(25127, gtqtcoreId("ka_oil"))
                .fluid()
                .color(0xFA7B53)
        ...
        GTQTMaterials.AdipicAcid = new Material.Builder(25128, gtqtcoreId("adipic_acid"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.NitrousAcid = new Material.Builder(25138, gtqtcoreId("nitrous_acid"))
                .fluid()
                .colorAverage()
                .components(Hydrogen, 1, Nitrogen, 1, Oxygen, 2)
                .build();

        GTQTMaterials.BariumOxide = new Material.Builder(25129, gtqtcoreId("barium_oxide"))
                .dust()
                .colorAverage()
                .components(Barium, 1, Oxygen, 1)
                .build();

        GTQTMaterials.BariumHydroxide = new Material.Builder(25130, gtqtcoreId("barium_hydroxide"))
                .dust()
                .colorAverage()
                .components(Barium, 1, Hydrogen, 1, Oxygen, 1)
                .build();

        GTQTMaterials.Cyclopentanone = new Material.Builder(25131, gtqtcoreId("cyclopentanone"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.BenzenesulfonicAcid = new Material.Builder(25132, gtqtcoreId("benzenesulfonic_acid"))
                .dust()
                .colorAverage()
                .components(Carbon, 6, Hydrogen, 6, Oxygen, 3, Sulfur, 1)
                .build();

        GTQTMaterials.TriphenylsulfoniumHexafluoroantimonate = new Material.Builder(25133, gtqtcoreId("triphenylsulfonium_hexafluoroantimonate"))
                .fluid()
                .color(0x8968FA)
                .components(Carbon, 18, Hydrogen, 15, Sulfur, 1, Antimony, 1, Fluorine, 6)
                .build();

        GTQTMaterials.HypofluorousAcid = new Material.Builder(25134, gtqtcoreId("hypofluorous_acid"))
                .fluid()
                .colorAverage()
                .components(Hydrogen, 1, Fluorine, 1, Oxygen, 1)
                .build();

        GTQTMaterials.HexafluoroantimonateSalt1 = new Material.Builder(25135, gtqtcoreId("hexafluoroantimonate_salt_1"))
                .fluid()
                .color(0x26095F)
        ...
        GTQTMaterials.HexafluoroantimonateSalt2 = new Material.Builder(25136, gtqtcoreId("hexafluoroantimonate_salt_2"))
                .fluid()
                .color(0x5A2F9F)
                .components(Carbon, 24, Hydrogen, 19, Sulfur, 2, Antimony, 1, Fluorine, 6)
                .build();

        GTQTMaterials.MixedHexafluoroantimonateSalts = new Material.Builder(25137, gtqtcoreId("mixed_hexafluoroantimonate_salts"))
                .fluid()
        ...
        GTQTMaterials.DiluteFluoroantimonicAcid = new Material.Builder(25139, gtqtcoreId("dilute_fluoroantimonic_acid"))
                .fluid()
                .flags(DISABLE_DECOMPOSITION)
                .colorAverage()
        ...
        GTQTMaterials.IndiumSolution = new Material.Builder(25140, gtqtcoreId("indium_solution"))
                .fluid()
                .color(0x58474C)
                .flags(DISABLE_DECOMPOSITION)
                .build()
        ...
        GTQTMaterials.IndiumSulfide = new Material.Builder(25141, gtqtcoreId("indium_sulfide"))
                .dust()
                .iconSet(MaterialIconSet.SHINY)
                .colorAverage()
        ...
        GTQTMaterials.IndiumResidue = new Material.Builder(25142, gtqtcoreId("indium_refining_residue"))
                .fluid()
                .iconSet(MaterialIconSet.LIGNITE)
                .color(0x060921)
                .build();

        GTQTMaterials.ZirconiumTetrafluoride = new Material.Builder(25143, gtqtcoreId("zirconium_fluoride"))
                .dust()
                .colorAverage()
                .components(Zirconium, 1, Fluorine, 4)
                .build();

        GTQTMaterials.BariumDifluoride = new Material.Builder(25144, gtqtcoreId("barium_fluoride"))
                .dust()
                .colorAverage()
                .components(Barium, 1, Fluorine, 2)
                .build();

        GTQTMaterials.LanthanumTrifluoride = new Material.Builder(25145, gtqtcoreId("lanthanum_fluoride"))
                .dust()
                .colorAverage()
                .components(Lanthanum, 1, Fluorine, 3)
                .build();

        GTQTMaterials.AluminiumTrifluoride = new Material.Builder(25146, gtqtcoreId("aluminium_fluoride"))
                .dust()
                .colorAverage()
                .components(Aluminium, 1, Fluorine, 3)
                .build();

        GTQTMaterials.SodiumFluoride = new Material.Builder(25147, gtqtcoreId("sodium_fluoride"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.HeavyRedMudResidue = new Material.Builder(25151, gtqtcoreId("red_mud_residue"))
                .fluid()
                .color(0x091012)
                .build();

        GTQTMaterials.RefractoryMetalResidue = new Material.Builder(25152, gtqtcoreId("refractory_metal_residue"))
                .fluid()
                .color(0x164347)
                .build();

        GTQTMaterials.PotassiumHexafluorohafnate = new Material.Builder(25153, gtqtcoreId("potassium_hexafluorohafnate"))
                .gem()
                .colorAverage()
                .components(Potassium, 2, Hafnium, 1, Fluorine, 6)
                .build();

        GTQTMaterials.PotassiumHexafluorozirconate = new Material.Builder(25154, gtqtcoreId("potassium_hexafluorozironate"))
                .gem()
                .colorAverage()
        ...
        GTQTMaterials.Trichlorosilane = new Material.Builder(25158, gtqtcoreId("trichlorosilane"))
                .fluid()
                .colorAverage()
                .components(Hydrogen, 1, Silicon, 1, Chlorine, 3)
                .build();

        GTQTMaterials.PotassiumHydride = new Material.Builder(25181, gtqtcoreId("potassium_hydride"))
                .dust()
                .components(Potassium, 1, Hydrogen, 1)
                .colorAverage()
                .build();

        GTQTMaterials.Aminopropionitrile = new Material.Builder(25159, gtqtcoreId("aminopropionitrile"))
                .fluid()
                .components(Carbon, 3, Hydrogen, 6, Nitrogen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.Aminopropylamine = new Material.Builder(25160, gtqtcoreId("aminopropylamine"))
                .fluid()
                .components(Carbon, 3, Hydrogen, 10, Nitrogen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.KAPA = new Material.Builder(25161, gtqtcoreId("kapa"))
                .fluid()
                .components(Potassium, 2, Carbon, 3, Hydrogen, 10, Nitrogen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.BetaPinene = new Material.Builder(25162, gtqtcoreId("betapinene"))
                .dust()
                .components(Carbon, 10, Hydrogen, 16)
                .colorAverage()
                .build();

        GTQTMaterials.AlphaPinene = new Material.Builder(25163, gtqtcoreId("alphapinene"))
                .dust()
                .components(Carbon, 10, Hydrogen, 16)
                .colorAverage()
                .build();

        GTQTMaterials.Camphene = new Material.Builder(25164, gtqtcoreId("camphene"))
                .dust()
                .components(Carbon, 10, Hydrogen, 16)
                .colorAverage()
                .build();

        GTQTMaterials.IsobornylAcetate = new Material.Builder(25165, gtqtcoreId("isobornyl_acetate"))
                .dust()
                .components(Carbon, 12, Hydrogen, 20, Oxygen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.Isoborneol = new Material.Builder(25166, gtqtcoreId("isoborneol"))
                .dust()
                .components(Carbon, 10, Hydrogen, 18, Oxygen, 1)
                .colorAverage()
                .build();

        GTQTMaterials.SodiumAcetate = new Material.Builder(25167, gtqtcoreId("sodium_acetate"))
                .fluid()
        ...
        GTQTMaterials.DehydrogenationCatalyst = new Material.Builder(25168, gtqtcoreId("dehydrogenation_catalyst"))
                .dust()
                .components()
                .color(0x2C1711)
                .build();

        GTQTMaterials.SodiumPerchlorate = new Material.Builder(25169, gtqtcoreId("sodium_perchlorate"))
                .dust()
        ...
        GTQTMaterials.Phenylhydrazine = new Material.Builder(25171, gtqtcoreId("phenylhydrazine"))
                .fluid()
                .components(Carbon, 6, Hydrogen, 8, Nitrogen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.BenzoylChloride = new Material.Builder(25172, gtqtcoreId("benzoyl_chloride"))
                .fluid()
                .components(Carbon, 7, Hydrogen, 5, Chlorine, 1, Oxygen, 1)
                .colorAverage()
                .build();

        GTQTMaterials.TriphenylMethoxytriazoylPerchlorate = new Material.Builder(25173, gtqtcoreId("triphenyl_methoxytriazoyl_perchlorate"))
                .dust()
        ...
        GTQTMaterials.SodiumMethoxide = new Material.Builder(25174, gtqtcoreId("sodium_methoxide"))
                .dust()
                .components(Carbon, 1, Hydrogen, 3, Sodium, 1, Oxygen, 1)
                .colorAverage()
                .build();

        GTQTMaterials.TriphenylMethoxytriazole = new Material.Builder(25175, gtqtcoreId("triphenyl_methoxytriazole"))
                .dust()
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.MetaNitrochlorobenzine = new Material.Builder(25179, gtqtcoreId("meta_nitrochlorobenzine"))
                .fluid()
                .components(Carbon, 6, Hydrogen, 4, Chlorine, 1, Nitrogen, 1, Oxygen, 2)
                .colorAverage()
                .build();

        GTQTMaterials.Nitroanisole = new Material.Builder(25180, gtqtcoreId("nitroanisole"))
                .fluid()
                .components(Carbon, 7, Hydrogen, 7, Nitrogen, 1, Oxygen, 3)
                .colorAverage()
                .build();

        GTQTMaterials.MethylBromoacetate = new Material.Builder(25183, gtqtcoreId("methyl_bromoacetate"))
                .dust()
                .colorAverage()
                .components(Carbon, 3, Hydrogen, 5, Bromine, 1, Oxygen, 2)
                .build();

        GTQTMaterials.CarbethoxymethyleneTriphenylphosphorane = new Material.Builder(25184, gtqtcoreId("carbomethoxy_methylenetriphenylphosphorane"))
                .dust()
                .colorAverage()
                .components(Carbon, 22, Hydrogen, 21, Oxygen, 2, Phosphorus, 1)
                .build();

        GTQTMaterials.PropargylAlcohol = new Material.Builder(25185, gtqtcoreId("propargyl_alcohol"))
                .fluid()
                .colorAverage()
                .components(Carbon, 3, Hydrogen, 4, Oxygen, 1)
                .build();

        GTQTMaterials.PropargylBromide = new Material.Builder(25186, gtqtcoreId("propargyl_bromide"))
                .fluid()
                .colorAverage()
                .components(Carbon, 3, Hydrogen, 3, Bromine, 1)
                .build();

        GTQTMaterials.MethylmagnesiumIodide = new Material.Builder(25187, gtqtcoreId("methylmagnesium_iodide"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.AcetylChloride = new Material.Builder(25188, gtqtcoreId("acetyl_chloride"))
                .fluid()
                .colorAverage()
                .components(Carbon, 2, Hydrogen, 3, Oxygen, 1, Chlorine, 1)
                .build();

        GTQTMaterials.Acetophenone = new Material.Builder(25189, gtqtcoreId("acetophenone"))
                .fluid()
                .colorAverage()
        ...
        GTQTMaterials.Phenylethylamine = new Material.Builder(25190, gtqtcoreId("phenylethylamine"))
                .fluid()
                .colorAverage()
                .components(Carbon, 8, Hydrogen, 11, Nitrogen, 1)
                .build();

        GTQTMaterials.PhenylethylIsocyanate = new Material.Builder(25191, gtqtcoreId("phenylethyl_isocyanate"))
                .fluid()
                .colorAverage()
                .components(Carbon, 9, Hydrogen, 9, Nitrogen, 1, Oxygen, 1)
                .build();

        GTQTMaterials.TriethyloxoniumTetrafluoroborate = new Material.Builder(25192, gtqtcoreId("triethyloxonium_tetrafluoroborate"))
                .dust()
                .colorAverage()
        ...
        GTQTMaterials.TrischloroethoxypopanylBorate = new Material.Builder(25193, gtqtcoreId("trischloroethoxypopanyl_borate"))
                .dust()
                .colorAverage()
                .components()
                .build();

        GTQTMaterials.SulfuricFlueGas = new Material.Builder(25194, gtqtcoreId("sulfuric_flue_gas"))
                .fluid()
                .color(0x6B6623)
                .build();

        GTQTMaterials.SulfuricIronSlag = new Material.Builder(25195, gtqtcoreId("sulfuric_iron_slag"))
                .ingot()
                .iconSet(MaterialIconSet.ROUGH)
                .color(0x616B33)
                .build();

        GTQTMaterials.SulfuricCopperSlag = new Material.Builder(25196, gtqtcoreId("sulfuric_copper_slag"))
                .ingot()
                .iconSet(MaterialIconSet.ROUGH)
                .color(0x975128)
                .build();

        GTQTMaterials.SulfuricNickelSlag = new Material.Builder(25197, gtqtcoreId("sulfuric_nickel_slag"))
                .ingot()
                .iconSet(MaterialIconSet.ROUGH)
                .color(0x769197)
                .build();

        GTQTMaterials.SulfuricZincSlag = new Material.Builder(25198, gtqtcoreId("sulfuric_zinc_slag"))
                .ingot()
                .iconSet(MaterialIconSet.ROUGH)
                .color(0xB5AECA)
                .build();

        GTQTMaterials.LanthanumOxide = new Material.Builder(3500, gtqtcoreId("lanthanum_oxide"))
                .dust()
                .color(0x5F7777)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.PraseodymiumOxide = new Material.Builder(3501, gtqtcoreId("praseodymium_oxide"))
                .dust()
                .color(0xD0D0D0)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.NeodymiumOxide = new Material.Builder(3502, gtqtcoreId("neodymium_oxide"))
                .dust()
                .color(0x868686)
                .components(Neodymium, 2, Oxygen, 3)
                .build();

        GTQTMaterials.ScandiumOxide = new Material.Builder(3504, gtqtcoreId("scandium_oxide"))
                .dust()
                .color(0x43964F)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.EuropiumOxide = new Material.Builder(3505, gtqtcoreId("europium_oxide"))
                .dust()
                .color(0x20AAAA)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.GadoliniumOxide = new Material.Builder(3506, gtqtcoreId("gadolinium_oxide"))
                .dust()
                .color(0xEEEEFF)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.SamariumOxide = new Material.Builder(3507, gtqtcoreId("samarium_oxide"))
                .dust()
                .color(0xFFFFDD)
                .components(Samarium, 2, Oxygen, 3)
                .build();

        GTQTMaterials.YttriumOxide = new Material.Builder(3508, gtqtcoreId("yttrium_oxide"))
                .dust()
                .color(0x78544E)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.TerbiumOxide = new Material.Builder(3509, gtqtcoreId("terbium_oxide"))
                .dust()
                .color(0xA264A2)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.DysprosiumOxide = new Material.Builder(3510, gtqtcoreId("dysprosium_oxide"))
                .dust()
                .color(0xD273D2)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.HolmiumOxide = new Material.Builder(3511, gtqtcoreId("holmium_oxide"))
                .dust()
                .color(0xAF7F2A)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.ErbiumOxide = new Material.Builder(3512, gtqtcoreId("erbium_oxide"))
                .dust()
                .color(0xE07A32)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.ThuliumOxide = new Material.Builder(3513, gtqtcoreId("thulium_oxide"))
                .dust()
                .color(0x3B9E8B)
                .components(Thulium, 2, Oxygen, 3)
                .build();

        GTQTMaterials.YtterbiumOxide = new Material.Builder(3514, gtqtcoreId("ytterbium_oxide"))
                .dust()
                .color(0xA9A9A9)
                .components(Ytterbium, 2, Oxygen, 3)
                .build();

        GTQTMaterials.LutetiumOxide = new Material.Builder(3515, gtqtcoreId("lutetium_oxide"))
                .dust()
                .color(0x11BBFF)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.PurifiedPlatinumGroupConcentrate = new Material.Builder(3516, gtqtcoreId("purified_platinum_group_concentrate"))
                .fluid()
                .color(0xFFFFC8)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.AmmoniumHexachloroplatinate = new Material.Builder(3517, gtqtcoreId("ammonium_hexachloroplatinate"))
                .fluid()
                .color(0xFEF0C2)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.AmmoniumHexachloropalladate = new Material.Builder(3518, gtqtcoreId("ammonium_hexachloropalladate"))
                .fluid()
                .color(0x808080)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SodiumNitrate = new Material.Builder(3519, gtqtcoreId("sodium_nitrate"))
                .dust().fluid()
                .color(0x846684)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.PotassiumHydroxide = new Material.Builder(3520, gtqtcoreId("potassium_hydroxide"))
                .dust()
        ...
        GTQTMaterials.CarbonTetrachloride = new Material.Builder(3521, gtqtcoreId("carbon_tetrachloride"))
                .fluid()
                .color(0x75201A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.RutheniumChloride = new Material.Builder(3522, gtqtcoreId("ruthenium_chloride"))
                .dust()
                .color(0x605C6C)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SodiumPeroxide = new Material.Builder(3523, gtqtcoreId("sodium_peroxide"))
                .dust()
                .color(0xECFF80)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.RhodiumOxide = new Material.Builder(3524, gtqtcoreId("rhodium_oxide"))
                .dust()
                .color(0xD93D16)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.SodiumChlorate = new Material.Builder(3525, gtqtcoreId("sodium_chlorate"))
                .dust().fluid()
                .color(0xAB8D85)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SulfurDichloride = new Material.Builder(3526, gtqtcoreId("sulfur_dichloride"))
                .fluid()
                .color(0x761410)
                .components(Sulfur, 1, Chlorine, 2)
                .build();

        GTQTMaterials.ThionylChloride = new Material.Builder(3527, gtqtcoreId("thionyl_chloride"))
                .fluid()
                .color(0xEBE863)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.OsmiumTetrachloride = new Material.Builder(3528, gtqtcoreId("osmium_tetrachloride"))
                .dust()
                .color(0x29080A)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.PotassiumBromate = new Material.Builder(3529, gtqtcoreId("potassium_bromate"))
                .dust()
                .color(0x782828)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.TungstenTrioxide = new Material.Builder(3530, gtqtcoreId("tungsten_trioxide"))
                .dust()
                .color(0xC7D300)
                .iconSet(MaterialIconSet.DULL)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.HydrogenPeroxide = new Material.Builder(3531, gtqtcoreId("hydrogen_peroxide"))
                .fluid()
                .color(0xD2FFFF)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Hydrazine = new Material.Builder(3532, gtqtcoreId("hydrazine"))
                .fluid()
                .color(0xB50707)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BerylliumOxide = new Material.Builder(3533, gtqtcoreId("beryllium_oxide"))
                .ingot()
                .color(0x54C757)
        ...
        GTQTMaterials.TantalumPentoxide = new Material.Builder(3534, gtqtcoreId("tantalum_pentoxide"))
                .dust().ingot()
                .color(0x72728A)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.NiobiumPentoxide = new Material.Builder(3535, gtqtcoreId("niobium_pentoxide"))
                .dust().fluid()
                .color(0xBAB0C3)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.CalciumDifluoride = new Material.Builder(3536, gtqtcoreId("calcium_difluoride"))
                .dust().fluid()
                .color(0xFFFC9E)
                .iconSet(MaterialIconSet.ROUGH)
                .components(Calcium, 1, Fluorine, 2)
        ...
        GTQTMaterials.ManganeseDifluoride = new Material.Builder(3537, gtqtcoreId("manganese_difluoride"))
                .dust().fluid()
                .color(0xEF4B3D)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.CalciumCarbide = new Material.Builder(3538, gtqtcoreId("calcium_carbide"))
                .dust().fluid()
                .color(0x807B70)
                .iconSet(MaterialIconSet.DULL)
        ...
        GTQTMaterials.CalciumHydroxide = new Material.Builder(3539, gtqtcoreId("calcium_hydroxide"))
                .dust().fluid()
                .color(0x5F8764)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SodiumCyanide = new Material.Builder(3540, gtqtcoreId("sodium_cyanide"))
                .dust().fluid()
                .color(0x5F7C8C)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.ChlorosulfuricAcid = new Material.Builder(3541, gtqtcoreId("chlorosulfuric_acid"))
                .fluid()
                .color(0x916C1D)
                .components(Hydrogen, 1, Sulfur, 1, Oxygen, 3, Chlorine, 1)
                .build();

        GTQTMaterials.CubicZirconia = new Material.Builder(3542, gtqtcoreId("cubic_zirconia"))
                .gem()
                .color(0xFFDFE2)
        ...
        GTQTMaterials.MolybdenumTrioxide = new Material.Builder(3543, gtqtcoreId("molybdenum_trioxide"))
                .dust()
                .color(0xCBCFDA)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.LeadChloride = new Material.Builder(3544, gtqtcoreId("lead_chloride"))
                .dust()
                .color(0xF3F3F3)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.SodiumTellurite = new Material.Builder(3545, gtqtcoreId("sodium_tellurite"))
                .dust()
                .color(0xC6C9BE)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.TelluriumDioxide = new Material.Builder(3546, gtqtcoreId("tellurium_dioxide"))
                .dust()
                .color(0xE3DDB8)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SeleniumDioxide = new Material.Builder(3547, gtqtcoreId("selenium_dioxide"))
                .dust()
                .color(0xE0DDD8)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SelenousAcid = new Material.Builder(3548, gtqtcoreId("selenous_acid"))
                .dust()
                .color(0xE0E083)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BoricAcid = new Material.Builder(3549, gtqtcoreId("boric_acid"))
                .dust().fluid()
                .color(0xFAFAFA)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BoronTrifluoride = new Material.Builder(3552, gtqtcoreId("boron_trifluoride"))
                .gas()
                .color(0xFAF191)
                .components(Boron, 1, Fluorine, 3)
                .build();

        GTQTMaterials.LithiumTetrafluoroborate = new Material.Builder(3553, gtqtcoreId("lithium_tetrafluoroborate"))
                .dust()
                .color(0x90FAF6)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Diborane = new Material.Builder(3554, gtqtcoreId("diborane"))
                .fluid()
                .color(0x3F3131)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Borazine = new Material.Builder(3555, gtqtcoreId("borazine")) //TODO "Boron Aromatic" tooltip
                .fluid()
                .color(0x542828)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BoronTrichloride = new Material.Builder(3556, gtqtcoreId("boron_trichloride"))
                .gas()
                .color(0x033F1B)
                .components(Boron, 1, Chlorine, 3)
                .build();

        GTQTMaterials.Trichloroborazine = new Material.Builder(3557, gtqtcoreId("trichloroborazine")) //TODO "Boron Aromatic" tooltip
                .fluid()
                .color(0xD62929)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.HexagonalBoronNitride = new Material.Builder(3558, gtqtcoreId("hexagonal_boron_nitride"))
                .gem().fluid()
                .color(0x6A6A72)
        ...
        GTQTMaterials.CubicBoronNitride = new Material.Builder(3559, gtqtcoreId("cubic_boron_nitride"))
                .gem().fluid()
                .color(0x545572)
                .iconSet(MaterialIconSet.DIAMOND)
        ...
        GTQTMaterials.AmorphousBoronNitride = new Material.Builder(3560, gtqtcoreId("amorphous_boron_nitride"))
                .ingot().fluid()
                .color(0x9193C5)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.Heterodiamond = new Material.Builder(3561, gtqtcoreId("heterodiamond"))
                .gem()
                .color(0x512A72)
        ...
        GTQTMaterials.CubicHeterodiamond = new Material.Builder(3562, gtqtcoreId("cubic_heterodiamond"))
                .gem()
                .color(0x753DA6)
                .iconSet(MaterialIconSet.DIAMOND)
                .flags(GENERATE_PLATE, DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.LithiumHydride = new Material.Builder(3563, gtqtcoreId("lithium_hydride"))
                .ingot()
                .color(0x9BAFDB)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.HydrobromicAcid = new Material.Builder(3564, gtqtcoreId("hydrobromic_acid"))
                .fluid()
                .color(0x8D1212)
                .components(Hydrogen, 1, Bromine, 1)
                .build();

        GTQTMaterials.WhitePhosphorus = new Material.Builder(3565, gtqtcoreId("white_phosphorus"))
                .gem()
                .color(0xECEADD)
        ...
        GTQTMaterials.RedPhosphorus = new Material.Builder(3566, gtqtcoreId("red_phosphorus"))
                .gem()
                .color(0x77040E)
                .iconSet(MaterialIconSet.FLINT)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.VioletPhosphorus = new Material.Builder(3567, gtqtcoreId("violet_phosphorus"))
                .gem()
                .color(0x8000FF)
                .iconSet(MaterialIconSet.FLINT)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BlackPhosphorus = new Material.Builder(3568, gtqtcoreId("black_phosphorus"))
                .dust()
                .color(0x36454F)
                .iconSet(MaterialIconSet.FLINT)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.BluePhosphorus = new Material.Builder(3569, gtqtcoreId("blue_phosphorus"))
                .gem()
                .color(0x9BE3E4)
                .iconSet(MaterialIconSet.FLINT)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Phosphorene = new Material.Builder(3570, gtqtcoreId("phosphorene"))
                .ingot()
                .color(0x273239)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.PhosphorusTrichloride = new Material.Builder(3571, gtqtcoreId("phosphorus_trichloride"))
                .fluid()
                .color(0xE8C474)
                .components(Phosphorus, 1, Chlorine, 3)
                .build();

        GTQTMaterials.PhosphorylChloride = new Material.Builder(3572, gtqtcoreId("phosphoryl_chloride"))
                .fluid()
                .color(0xE8BB5B)
                .components(Phosphorus, 1, Oxygen, 1, Chlorine, 3)
                .build();

        GTQTMaterials.ZincOxide = new Material.Builder(3573, gtqtcoreId("zinc_oxide"))
                .dust()
                .color(0xB85C34)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
        ...
        GTQTMaterials.GermaniumTetrachloride = new Material.Builder(3574, gtqtcoreId("germanium_tetrachloride"))
                .fluid()
                .color(0x787878)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.GermaniumDioxide = new Material.Builder(3575, gtqtcoreId("germanium_dioxide"))
                .dust()
                .color(0x666666)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SiliconTetrachloride = new Material.Builder(3576, gtqtcoreId("silicon_tetrachloride"))
                .fluid()
                .color(0x5B5B7A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.GSTGlass = new Material.Builder(3577, gtqtcoreId("gst_glass"))
                .ingot().fluid()
                .color(0xCFFFFF)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.ZBLANGlass = new Material.Builder(3578, gtqtcoreId("zblan_glass"))
                .ingot().fluid()
                .color(0xACB4BC)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.HeliumNeon = new Material.Builder(3579, gtqtcoreId("helium_neon"))
                .gas()
                .color(0xFF0080)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        GTQTMaterials.AluminiumHydroxide = new Material.Builder(3580, gtqtcoreId("aluminium_hydroxide"))
                .dust()
                .color(0xBEBEC8)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.AluminiumTrichloride = new Material.Builder(3581, gtqtcoreId("aluminium_trichloride"))
                .dust()
                .color(0x78C3EB)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.GalliumTrichloride = new Material.Builder(3582, gtqtcoreId("gallium_trichloride"))
                .dust()
                .color(0x6EB4FF)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.GalliumTrioxide = new Material.Builder(3583, gtqtcoreId("gallium_trioxide"))
                .dust().fluid()
                .color(0xE4CDFF)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.GalliumNitride = new Material.Builder(3584, gtqtcoreId("gallium_nitride"))
                .ingot()
                .color(0xFFF458)
                .iconSet(MaterialIconSet.SHINY)
                .flags(GENERATE_PLATE)
        ...
        GTQTMaterials.CadmiumBromide = new Material.Builder(3585, gtqtcoreId("cadmium_bromide"))
                .dust()
                .color(0xFF1774)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.MagnesiumBromide = new Material.Builder(3586, gtqtcoreId("magnesium_bromide"))
                .dust()
                .color(0x5F4C32)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.CadmiumSulfide = new Material.Builder(3587, gtqtcoreId("cadmium_sulfide"))
                .dust().ingot()
                .color(0xC8C43C)
        ...
        GTQTMaterials.CadmiumSelenide = new Material.Builder(3588, gtqtcoreId("cadmium_selenide")) //TODO "Quantum Dots" tooltip
                .dust()
                .color(0x983034)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.Phosphine = new Material.Builder(3589, gtqtcoreId("phosphine"))
                .gas()
                .color(0xACB330)
        ...
        GTQTMaterials.PlutoniumTrihydride = new Material.Builder(3590, gtqtcoreId("plutonium_trihydride"))
                .dust()
                .color(0x140002)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.PlutoniumPhosphide = new Material.Builder(3591, gtqtcoreId("plutonium_phosphide"))
                .ingot()
                .color(0x1F0104)
        ...
        GTQTMaterials.CarbonNanotube = new Material.Builder(3592, gtqtcoreId("carbon_nanotube"))
                .ingot().fluid()
                .color(0x05090C)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        GTQTMaterials.LithiumHydroxide = new Material.Builder(3593, gtqtcoreId("lithium_hydroxide"))
                .dust()
                .color(0xDECAFA)
        ...
        GTQTMaterials.LithiumAmalgam = new Material.Builder(3594, gtqtcoreId("lithium_amalgam"))
                .fluid()
        ...
        GTQTMaterials.Lithium7Hydroxide = new Material.Builder(3595, gtqtcoreId("lithium_7_hydroxide"))
                .dust()
                .fluid()
        ...
        GTQTMaterials.NeptuniumAluminide = new Material.Builder(3596, gtqtcoreId("neptunium_aluminide"))
                .ingot().fluid()
                .color(0x5E228F)
                .iconSet(MaterialIconSet.MAGNETIC)
                .flags(GENERATE_PLATE, GENERATE_ROD, GENERATE_LONG_ROD)
        ...
        GTQTMaterials.BismuthTrioxide = new Material.Builder(3597, gtqtcoreId("bismuth_trioxide"))
                .dust()
                .color(0xF5EF42).iconSet(MaterialIconSet.FINE)
                .components(Bismuth, 2, Oxygen, 3)
                .build();

        GTQTMaterials.FerricOxide = new Material.Builder(3598, gtqtcoreId("ferric_oxide"))
                .dust()
                .color(0x915A5A).iconSet(MaterialIconSet.ROUGH)
                .components(Iron, 2, Oxygen, 3)
                .build();

        GTQTMaterials.BismuthChalcogenide = new Material.Builder(3599, gtqtcoreId("bismuth_chalcogenide")) //TODO "3D Topological Isolator" tooltip
                .ingot()
        ...
        GTQTMaterials.MercuryCadmiumTelluride = new Material.Builder(3600, gtqtcoreId("mercury_cadmium_telluride"))
                .ingot().fluid()
        ...
        GTQTMaterials.AluminiumSelenide = new Material.Builder(3601, gtqtcoreId("aluminium_selenide"))
                .dust()
                .color(0x969651)
                .components(Aluminium, 2, Selenium, 3)
                .build();

        GTQTMaterials.HydrogenSelenide = new Material.Builder(3602, gtqtcoreId("hydrogen_selenide"))
                .gas()
                .color(0x42f554)
                .components(Hydrogen, 2, Selenium, 1)
                .build();

        GTQTMaterials.PalladiumNitrate = new Material.Builder(3603, gtqtcoreId("palladium_nitrate"))
                .dust()
        ...
        GTQTMaterials.Fullerene = new Material.Builder(3604, gtqtcoreId("fullerene"))
                .ingot()
                .color(0x72556A)
                .iconSet(MaterialIconSet.BRIGHT)
        ...
        GTQTMaterials.ThalliumCopperChloride = new Material.Builder(3605, gtqtcoreId("thallium_copper_chloride")) //TODO "Antiferromagnetic" Tooltip
                .ingot().fluid()
                .color(0x3C5CB5)
                .iconSet(MaterialIconSet.MAGNETIC)
                .flags(GENERATE_FINE_WIRE)
        ...
        GTQTMaterials.PerrhenicAcid = new Material.Builder(3606, gtqtcoreId("perrhenic_acid"))
                .dust()
                .color(0xE6DC70)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.AmmoniumPerrhenate = new Material.Builder(3607, gtqtcoreId("ammonium_perrhenate"))
                .dust()
                .color(0xA69970)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.ThalliumSulfate = new Material.Builder(3608, gtqtcoreId("thallium_sulfate"))
                .dust()
                .color(0x9C222C)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.HeavyTaraniumFuel = new Material.Builder(3609, gtqtcoreId("heavy_taranium_fuel"))
                .fluid()
                .color(0x141414)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.MediumTaraniumFuel = new Material.Builder(3610, gtqtcoreId("medium_taranium_fuel"))
                .fluid()
                .color(0x181818)
                .flags(DISABLE_DECOMPOSITION)
                .components(GTQTMaterials.Taranium, 1)
        ...
        GTQTMaterials.LightTaraniumFuel = new Material.Builder(3611, gtqtcoreId("light_taranium_fuel"))
                .fluid()
                .color(0x1C1C1C)
                .flags(DISABLE_DECOMPOSITION)
                .components(GTQTMaterials.Taranium, 1)
        ...
        GTQTMaterials.HeavyEnrichedTaraniumFuel = new Material.Builder(3612, gtqtcoreId("heavy_enriched_taranium_fuel"))
                .fluid()
                .color(0x0F1414)
                .flags(DISABLE_DECOMPOSITION)
                .components(GTQTMaterials.Taranium, 1)
        ...
        GTQTMaterials.MediumEnrichedTaraniumFuel = new Material.Builder(3613, gtqtcoreId("medium_enriched_taranium_fuel"))
                .fluid()
                .color(0x0F1818)
                .flags(DISABLE_DECOMPOSITION)
                .components(GTQTMaterials.Taranium, 1)
        ...
        GTQTMaterials.LightEnrichedTaraniumFuel = new Material.Builder(3614, gtqtcoreId("light_enriched_taranium_fuel"))
                .fluid()
                .color(0x0F1C1C)
                .flags(DISABLE_DECOMPOSITION)
                .components(GTQTMaterials.Taranium, 1)
        ...
        GTQTMaterials.Adamantite = new Material.Builder(3615, gtqtcoreId("adamantite"))
                .dust()
        ...
        GTQTMaterials.AdamantiumUnstable = new Material.Builder(3616, gtqtcoreId("adamantium_unstable"))
                .fluid()
                .color(0xFF763C)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.OrichalcumEnergized = new Material.Builder(3617, gtqtcoreId("orichalcum_energized"))
                .dust()
                .color(0xF4FC0C)
                .iconSet(MaterialIconSet.BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.AdamantiumEnriched = new Material.Builder(3618, gtqtcoreId("adamantium_enriched"))
                .dust()
                .color(0x64B4FF)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.DeepIron = new Material.Builder(3619, gtqtcoreId("deep_iron"))
                .dust()
                .color(0x968C8C)
                .iconSet(MaterialIconSet.METALLIC)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.VibraniumUnstable = new Material.Builder(3620, gtqtcoreId("vibranium_unstable"))
                .fluid()
                .color(0xFF7832)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.SiliconCarbide = new Material.Builder(3621, gtqtcoreId("silicon_carbide")) //TODO Carborundum tooltip
                .dust()
                .fluid()
                .color(0x4D4D4D)
                .iconSet(METALLIC)
        ...
        GTQTMaterials.ChromiumGermaniumTelluride = new Material.Builder(3622, gtqtcoreId("cgt"))
                .ingot().fluid()
                .color(0x8F103E)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.Kovar = new Material.Builder(3623, gtqtcoreId("kovar"))
                .ingot()
                .color(0xCBC0A6)
        ...
        GTQTMaterials.StannicChloride = new Material.Builder(3624, gtqtcoreId("stannic_chloride"))
                .fluid()
                .color(0x33BBF5)
                .components(Tin, 1, Chlorine, 4)
                .build();

        GTQTMaterials.RubidiumChlorostannate = new Material.Builder(3625, gtqtcoreId("rubidium_chlorostannate"))
                .dust()
                .color(0xBD888A)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.CaesiumChlorostannate = new Material.Builder(3626, gtqtcoreId("caesium_chlorostannate"))
                .dust()
                .color(0xBDAD88)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.HRAMagnesium = new Material.Builder(3627, gtqtcoreId("hra_magnesium")) //TODO "Reike Metal" tooltip
                .dust()
        ...
        GTQTMaterials.LithiumFluoride = new Material.Builder(3628, gtqtcoreId("lithium_fluoride"))
                .dust()
                .color(0x9AE7AD)
                .components(Lithium, 1, Fluorine, 1)
                .build();

        GTQTMaterials.Alumina = new Material.Builder(3629, gtqtcoreId("alumina"))
                .dust()
                .color(0x0b5394).iconSet(MaterialIconSet.SHINY)
                .components(Aluminium, 2, Oxygen, 3)
                .build();

        GTQTMaterials.Hematite = new Material.Builder(3630, gtqtcoreId("hematite"))
                .dust().ore()
                .color(0xa52222)
                .components(Iron, 2, Oxygen, 3)
                .build();

        GTQTMaterials.Tetrahydrofuran = new Material.Builder(15000, gtqtcoreId("tetrahydrofuran")) //TODO "THF" tooltip
                .fluid()
                .color(0x3234A8)
                .components(Carbon, 4, Hydrogen, 8, Oxygen, 1)
                .build();

        GTQTMaterials.Ethylhexanol = new Material.Builder(15001, gtqtcoreId("ethylhexanol"))
                .fluid()
                .color(0xFEEA9A)
                .components(Carbon, 8, Hydrogen, 10, Oxygen, 1)
                .build();

        GTQTMaterials.DiethylhexylPhosphoricAcid = new Material.Builder(15002, gtqtcoreId("diethylhexyl_phosphoric_acid"))
                .fluid()
                .color(0xFFFF99)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Butanol = new Material.Builder(15003, gtqtcoreId("butanol"))
                .fluid()
                .color(0xC7AF2E)
        ...
        GTQTMaterials.MethylFormate = new Material.Builder(15004, gtqtcoreId("methyl_formate"))
                .fluid()
                .color(0xFFAAAA)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.FormicAcid = new Material.Builder(15005, gtqtcoreId("formic_acid"))
        ...
        GTQTMaterials.PhthalicAnhydride = new Material.Builder(15006, gtqtcoreId("phthalic_anhydride"))
                .dust()
                .color(0xEEAAEE)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Ethylanthraquinone = new Material.Builder(15007, gtqtcoreId("ethylanthraquinone"))
                .fluid()
                .color(0xCC865A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Ethylanthrahydroquinone = new Material.Builder(15008, gtqtcoreId("ethylanthrahydroquinone"))
                .fluid()
                .color(0xAD531A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Formaldehyde = new Material.Builder(15009, gtqtcoreId("formaldehyde"))
                .fluid()
                .color(0x95A13A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Acetylene = new Material.Builder(15010, gtqtcoreId("acetylene"))
                .fluid()
                .color(0x959C60)
                .components(Carbon, 2, Hydrogen, 2)
                .build();

        GTQTMaterials.Turpentine = new Material.Builder(15013, gtqtcoreId("turpentine"))
                .fluid()
                .color(0x93BD46)
                .flags(DISABLE_DECOMPOSITION)
                .components(Carbon, 10, Hydrogen, 16)
        ...
        GTQTMaterials.Dichloroethane = new Material.Builder(15014, gtqtcoreId("dichloroethane"))
                .fluid()
                .color(0xDAAED3)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Trichloroethylene = new Material.Builder(15015, gtqtcoreId("trichloroethylene"))
                .fluid()
                .color(0xB685B1)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.ChloroaceticAcid = new Material.Builder(15016, gtqtcoreId("chloroacetic_acid"))
                .fluid()
                .color(0x38541A)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.MalonicAcid = new Material.Builder(15017, gtqtcoreId("malonic_acid"))
                .dust()
                .color(0x61932E)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.TetramethylammoniumChloride = new Material.Builder(15018, gtqtcoreId("tetramethylammonium_chloride"))
                .dust().fluid()
                .color(0x27FF81)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.METALLIC)
        ...
        GTQTMaterials.Ethylenediamine = new Material.Builder(15019, gtqtcoreId("ethylenediamine"))
                .fluid()
                .color(0xD00ED0)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.HydrogenCyanide = new Material.Builder(15020, gtqtcoreId("hydrogen_cyanide"))
                .fluid()
                .color(0xB6D1AE)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.TetrasodiumEDTA = new Material.Builder(15021, gtqtcoreId("tetrasodium_edta"))
                .dust()
                .color(0x8890E0)
                .iconSet(MaterialIconSet.SHINY)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.EthylenediaminetetraaceticAcid = new Material.Builder(15022, gtqtcoreId("ethylenediaminetetraacetic_acid")) //TODO EDTA Tooltip
                .fluid()
                .color(0x87E6D9)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Aniline = new Material.Builder(15026, gtqtcoreId("aniline"))
                .fluid()
                .color(0x4C911D)
        ...
        GTQTMaterials.ParaXylene = new Material.Builder(15030, gtqtcoreId("para_xylene"))
                .fluid()
                .color(0x666040)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Durene = new Material.Builder(15031, gtqtcoreId("durene"))
                .dust()
                .color(0x336040)
                .iconSet(MaterialIconSet.FINE)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.PyromelliticDianhydride = new Material.Builder(15032, gtqtcoreId("pyromellitic_dianhydride")) //TODO PDMA Tooltip
                .dust()
                .color(0xF0EAD6)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Aminophenol = new Material.Builder(15033, gtqtcoreId("aminophenol"))
                .fluid()
                .color(0xFF7F50)
        ...
        GTQTMaterials.Dimethylformamide = new Material.Builder(15034, gtqtcoreId("dimethylformamide")) //TODO DMF Tooltip
                .fluid()
                .color(0x42BDFF)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Oxydianiline = new Material.Builder(15035, gtqtcoreId("oxydianiline")) //TODO ODA Tooltip
                .dust()
                .color(0xF0E130)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.KaptonK = new Material.Builder(15036, gtqtcoreId("kapton_k")) //TODO Poly 4,4'-oxydiphenylene-pyromellitimide Tooltip
                .ingot().fluid()
                .color(0xFFCE52)
                .flags(DISABLE_DECOMPOSITION, NO_SMASHING, NO_SMELTING, GENERATE_PLATE, GENERATE_FOIL)
                .components(Carbon, 12, Hydrogen, 12, Nitrogen, 2, Oxygen, 1)
        ...
        GTQTMaterials.BiphenylTetracarboxylicAcidDianhydride = new Material.Builder(15037, gtqtcoreId("biphenyl_tetracarboxylic_acid_dianhydride")) //TODO BPDA Tooltip
                .dust()
                .color(0xFF7F50)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Nitroaniline = new Material.Builder(15038, gtqtcoreId("nitroaniline"))
                .fluid()
                .color(0x2A6E68)
        ...
        GTQTMaterials.ParaPhenylenediamine = new Material.Builder(15039, gtqtcoreId("para_phenylenediamine"))
                .dust()
                .color(0x4A8E7B)
                .iconSet(MaterialIconSet.ROUGH)
                .components(Carbon, 6, Hydrogen, 8, Nitrogen, 2)
        ...
        GTQTMaterials.KaptonE = new Material.Builder(15040, gtqtcoreId("kapton_e"))
                .ingot().fluid()
                .color(0xFFDF8C)
        ...
        GTQTMaterials.Methylamine = new Material.Builder(15041, gtqtcoreId("methylamine"))
                .gas()
                .color(0xAA6600)
        ...
        GTQTMaterials.Trimethylamine = new Material.Builder(15042, gtqtcoreId("trimethylamine"))
                .gas()
                .color(0xBB7700)
        ...
        GTQTMaterials.Bistrichloromethylbenzene = new Material.Builder(15043, gtqtcoreId("bistrichloromethylbenzene"))
                .fluid()
                .color(0xCF8498)
        ...
        GTQTMaterials.Tetrabromoethane = new Material.Builder(15044, gtqtcoreId("tetrabromoethane"))
                .fluid()
                .color(0x5AAADA)
                .components(Carbon, 2, Hydrogen, 2, Bromine, 4)
                .build();

        GTQTMaterials.TerephthalicAcid = new Material.Builder(15045, gtqtcoreId("terephthalic_acid")) //TODO "PTA" Tooltip
                .dust()
                .color(0x5ACCDA)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        GTQTMaterials.TerephthaloylChloride = new Material.Builder(15046, gtqtcoreId("terephthaloyl_chloride"))
                .dust()
                .color(0xFAC4DA)
                .iconSet(MaterialIconSet.SHINY)
        ...
        GTQTMaterials.Butanediol = new Material.Builder(15047, gtqtcoreId("butanediol"))
                .fluid()
                .color(0xAAC4DA)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.GammaButyrolactone = new Material.Builder(15048, gtqtcoreId("gamma_butyrolactone")) //TODO "GBL" tooltip
                .fluid()
                .color(0xAF04D6)
                .components(Carbon, 4, Hydrogen, 6, Oxygen, 2)
                .build();

        GTQTMaterials.NMethylPyrrolidone = new Material.Builder(15049, gtqtcoreId("n_methyl_pyrrolidone"))
                .fluid()
                .color(0xA504D6)
                .components(Carbon, 5, Hydrogen, 9, Nitrogen, 1, Oxygen, 1)
                .build();

        GTQTMaterials.Kevlar = new Material.Builder(15050, gtqtcoreId("kevlar"))
                .polymer()
                .liquid().ingot()
                .color(0xF0F078)
                .flags(DISABLE_DECOMPOSITION, NO_SMASHING, NO_SMELTING, GENERATE_PLATE,
        ...
        GTQTMaterials.TetramethylammoniumHydroxide = new Material.Builder(15051, gtqtcoreId("tetramethylammonium_hydroxide")) //TODO "TMAH" tooltip
        ...
        GTQTMaterials.Pyrocatechol = new Material.Builder(15052, gtqtcoreId("pyrocatechol"))
                .dust()
                .color(0x784421)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(MaterialIconSet.DULL)
        ...
        GTQTMaterials.EthyleneOxide = new Material.Builder(15053, gtqtcoreId("ethylene_oxide"))
                .gas()
                .color(0xDCBFE1)
                .components(Carbon, 2, Hydrogen, 4, Oxygen, 1)
                .build();

        GTQTMaterials.EthyleneGlycol = new Material.Builder(15054, gtqtcoreId("ethylene_glycol"))
                .fluid()
                .color(0x286632)
        ...
        GTQTMaterials.Diacetyl = new Material.Builder(15055, gtqtcoreId("diacetyl")) //TODO "Tastes like butter" tooltip
                .fluid()
                .color(0xF7FF65)
                .components(Carbon, 4, Hydrogen, 6, Oxygen, 2)
                .build();

        GTQTMaterials.AcetoneCyanohydrin = new Material.Builder(15056, gtqtcoreId("acetone_cyanohydrin"))
                .fluid()
                .color(0xA1FFD0)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.PMMA = new Material.Builder(15057, gtqtcoreId("polymethylmethacrylate")) //TODO PMMA tooltip
                .ingot().fluid()
                .color(0x91CAE1)
                .flags(DISABLE_DECOMPOSITION, NO_SMASHING, NO_SMELTING, GENERATE_PLATE)
                .components(Carbon, 5, Hydrogen, 8, Oxygen, 2)
        ...
        GTQTMaterials.Trimethylaluminium = new Material.Builder(15058, gtqtcoreId("trimethylaluminium"))
                .fluid()
                .color(0x6ECCFF)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Trimethylgallium = new Material.Builder(15059, gtqtcoreId("trimethylgallium"))
                .fluid()
                .color(0x4F92FF)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.EthyleneDibromide = new Material.Builder(15060, gtqtcoreId("ethylene_dibromide")) //TODO "EDB" tooltip
                .fluid()
                .color(0x4F1743)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.GrignardReagent = new Material.Builder(15061, gtqtcoreId("grignard_reagent"))
                .fluid()
                .color(0xA12AA1)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Dimethylcadmium = new Material.Builder(15062, gtqtcoreId("dimethylcadmium"))
                .fluid()
                .color(0x5C037F)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.DiethylSuflide = new Material.Builder(15063, gtqtcoreId("diethyl_sulfide"))
                .fluid()
                .color(0xFF7E4B)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Cycloparaphenylene = new Material.Builder(15064, gtqtcoreId("cycloparaphenylene")) //TODO "CPP" tooltip
                .fluid()
                .color(0x60545A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.Indene = new Material.Builder(15065, gtqtcoreId("indene"))
                .fluid()
                .color(0x171429)
                .components(Carbon, 9, Hydrogen, 8)
                .build();

        GTQTMaterials.Indanone = new Material.Builder(15066, gtqtcoreId("indanone"))
                .dust()
        ...
        GTQTMaterials.Truxene = new Material.Builder(15067, gtqtcoreId("truxene"))
                .fluid()
                .color(0x1A3336)
                .components(Carbon, 27, Hydrogen, 18)
                .build();

        GTQTMaterials.Bromomethane = new Material.Builder(15068, gtqtcoreId("bromomethane"))
                .gas()
                .color(0xC82C31)
                .components(Carbon, 1, Hydrogen, 3, Bromine, 1)
                .build();

        GTQTMaterials.BromoBromomethylNaphthalene = new Material.Builder(15069, gtqtcoreId("bromo_bromomethyl_naphthalene"))
                .fluid()
                .color(0x52122E)
                .components(Carbon, 11, Hydrogen, 8, Bromine, 2)
                .build();

        GTQTMaterials.Bromobutane = new Material.Builder(15070, gtqtcoreId("bromobutane"))
                .gas()
                .color(0xE6E8A2)
        ...
        GTQTMaterials.Butyllithium = new Material.Builder(15071, gtqtcoreId("butyllithium"))
                .fluid()
                .color(0xE683B6B)
        ...
        GTQTMaterials.PalladiumAcetate = new Material.Builder(15072, gtqtcoreId("palladium_acetate"))
                .dust()
        ...
        GTQTMaterials.GeodesicPolyarene = new Material.Builder(15073, gtqtcoreId("geodesic_polyarene"))
                .dust()
        ...
        GTQTMaterials.Edot = new Material.Builder(15074, gtqtcoreId("edot"))
                .fluid()
                .color(0xB1FFD7)
                .components(Carbon, 6, Hydrogen, 6, Oxygen, 2, Sulfur, 1)
                .build();

        GTQTMaterials.Polystyrene = new Material.Builder(15075, gtqtcoreId("polystyrene"))
                .fluid()
                .color(0xE1C2C2)
                .flags(DISABLE_DECOMPOSITION)
        ...
        GTQTMaterials.PolystyreneSulfonate = new Material.Builder(15076, gtqtcoreId("polystyrene_sulfonate"))
                .ingot().fluid()
                .color(0xE17C72)
        ...
        GTQTMaterials.PedotPSS = new Material.Builder(15077, gtqtcoreId("pedot_pss"))
                .ingot().fluid()
                .color(0xE165A7)
        ...
        GTQTMaterials.PedotTMA = new Material.Builder(15078, gtqtcoreId("pedot_tma"))
                .ingot().fluid()
                .color(0x5E9EE1)
