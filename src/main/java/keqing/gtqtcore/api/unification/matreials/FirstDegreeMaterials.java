...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        GTQTMaterials.LightNaquadahFuel = (new Material.Builder(20008, GTUtility.gregtechId("light_naquadah_fuel"))).fluid(FluidTypes.LIQUID).plasma().fluidTemp(18000).color(14638000).build().setFormula("NQ", true);
        GTQTMaterials.MediumNaquadahFuel = (new Material.Builder(20009, GTUtility.gregtechId("medium_naquadah_fuel"))).fluid(FluidTypes.LIQUID).plasma().fluidTemp(18000).color(14638000).build().setFormula("-NQ-", true);
        GTQTMaterials.HeavyNaquadahFuel = (new Material.Builder(20010, GTUtility.gregtechId("heavy_naquadah_fuel"))).fluid(FluidTypes.LIQUID).plasma().fluidTemp(18000).color(14638000).build().setFormula("+NQ+", true);
