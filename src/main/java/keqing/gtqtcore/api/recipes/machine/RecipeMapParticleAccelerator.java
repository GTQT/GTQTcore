...
public class RecipeMapParticleAccelerator<R extends RecipeBuilder<R>> extends RecipeMap<R> {

    public RecipeMapParticleAccelerator(@Nonnull String unlocalizedName, int maxInputs, int maxOutputs, int maxFluidInputs, int maxFluidOutputs, @Nonnull R defaultRecipeBuilder, boolean isHidden) {
    ...
    public ModularUI.Builder createJeiUITemplate(IItemHandlerModifiable importItems, IItemHandlerModifiable exportItems, FluidTankList importFluids, FluidTankList exportFluids, int yOffset) {
        ...
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 166)
                .widget(new RecipeProgressWidget(200, 75 , 23 + newYOffset - 6, 20, 20, progressBarTexture, moveType, this));
