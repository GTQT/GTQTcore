...
public class SFMDistillationTowerUI<R extends RecipeMap<?>> extends RecipeMapUI<R> {

    public SFMDistillationTowerUI(R recipeMap) {
    ...
    @Override
    public ModularUI.Builder createJeiUITemplate(net.minecraftforge.items.IItemHandlerModifiable
    importItems, net.minecraftforge.items.IItemHandlerModifiable exportItems,
