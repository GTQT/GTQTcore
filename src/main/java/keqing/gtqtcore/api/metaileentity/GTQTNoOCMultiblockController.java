...
public abstract class GTQTNoOCMultiblockController extends MultiMapMultiblockController {
    ...
    public GTQTNoOCMultiblockController(ResourceLocation metaTileEntityId, RecipeMap<?>[] recipeMaps) {
    ...
    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        ...
        builder.widget(new ClickButtonWidget(200, 142, 40, 20, "gui.reset", data ->
                energyHatchMaxWork = 32).setTooltipText("gui.reset_tooltip"));

        builder.widget(new ClickButtonWidget(240, 142, 40, 20, "gui.recommend", data ->
        {
