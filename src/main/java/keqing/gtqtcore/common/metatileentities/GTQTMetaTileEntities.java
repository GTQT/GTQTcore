...
public class GTQTMetaTileEntities {
    ...
    public static void initialization() {
        ...
        ROCKET_ENGINE[0] = registerMetaTileEntity(3006, new SimpleGeneratorMetaTileEntity(gtqtcoreId("rocket_engine.hv"), GTQTcoreRecipeMaps.ROCKET, GTQTTextures.ROCKET_ENGINE_OVERLAY, 3, genericGeneratorTankSizeFunctionPlus));
        ROCKET_ENGINE[1] = registerMetaTileEntity(3007, new SimpleGeneratorMetaTileEntity(gtqtcoreId("rocket_engine.ev"), GTQTcoreRecipeMaps.ROCKET, GTQTTextures.ROCKET_ENGINE_OVERLAY, 4, genericGeneratorTankSizeFunctionPlus));
        ROCKET_ENGINE[2] = registerMetaTileEntity(3008, new SimpleGeneratorMetaTileEntity(gtqtcoreId("rocket_engine.iv"), GTQTcoreRecipeMaps.ROCKET, GTQTTextures.ROCKET_ENGINE_OVERLAY, 5, genericGeneratorTankSizeFunctionPlus));
       ...
       // COKING_TOWER = registerMetaTileEntity(3206, new MetaTileEntityCokingTower(gtqtcoreId("coking_tower")));
        ...
        DARMSTADTIUM_DRUM = MetaTileEntities.registerMetaTileEntity(14482, new MetaTileEntityDrum(gtqtcoreId("drum.darmstadtium"), Materials.Darmstadtium, 8_192_000));
        NEUTRONIUM_DRUM = MetaTileEntities.registerMetaTileEntity(14483, new MetaTileEntityDrum(gtqtcoreId("drum.neutronium"), Materials.Neutronium, 16_384_000));
        // ID 14011-14020: Crates
        RHODIUM_PLATED_PALLADIUM_CRATE = MetaTileEntities.registerMetaTileEntity(14490, new MetaTileEntityCrate(gtqtcoreId("crate.rhodium_plated_palladium"), Materials.RhodiumPlatedPalladium, 162));
        NAQUADAH_ALLOY_CRATE = MetaTileEntities.registerMetaTileEntity(14491, new MetaTileEntityCrate(gtqtcoreId("crate.naquadah_alloy"), Materials.NaquadahAlloy, 180));
        DARMSTADTIUM_CRATE = MetaTileEntities.registerMetaTileEntity(14492, new MetaTileEntityCrate(gtqtcoreId("crate.darmstadtium"), Materials.Darmstadtium, 198));
        ...
        registerSimpleSteamMetaTileEntity(STEAM_SPINNER, 14502, "spinner", GTQTcoreRecipeMaps.SPINNER_RECIPES, COMPRESS, Textures.WIREMILL_OVERLAY, false);
