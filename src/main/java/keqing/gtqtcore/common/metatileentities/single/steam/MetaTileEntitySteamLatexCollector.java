...
public class MetaTileEntitySteamLatexCollector extends PseudoMultiSteamMachineMetaTileEntity {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        GTQTTextures.DRYER_OVERLAY.renderOrientedState(renderState, translation, coloredPipeline, this.getFrontFacing(), this.isActive(), true);
    ...
    public void update() {
        ...
        if (this.hasRubberLog && this.drainEnergy(true)) {
            ...
            if (stored < capacity) {
                ...
                //handle cases
                if (isOutputFull) {
                    tank.fill(GTQTMaterials.Latex.getFluid(capacity - stored), true);
                } else {
                    tank.fill(GTQTMaterials.Latex.getFluid((int) this.latexCollectionAmount), true);
                }
