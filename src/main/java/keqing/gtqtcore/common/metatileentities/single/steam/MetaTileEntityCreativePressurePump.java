...
public class MetaTileEntityCreativePressurePump extends MetaTileEntity {
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing side) {
        if (capability == GTQTTileCapabilities.CAPABILITY_PRESSURE_CONTAINER) {
            return GTQTTileCapabilities.CAPABILITY_PRESSURE_CONTAINER.cast(this.pressureContainer);
        }
    ...
    public void update() {
        ...
        for (EnumFacing facing : EnumFacing.values()) {
            ...
            if (tile != null) {
                IPressureContainer container = tile.getCapability(GTQTTileCapabilities.CAPABILITY_PRESSURE_CONTAINER, facing.getOpposite());
