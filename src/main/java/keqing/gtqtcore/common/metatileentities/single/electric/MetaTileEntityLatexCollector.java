...
public class MetaTileEntityLatexCollector extends PseudoMultiMachineMetaTileEntity {
    ...
    public MetaTileEntityLatexCollector(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, GTQTcoreRecipeMaps.LATEX_COLLECTOR_RECIPES, GTQTTextures.DRYER_OVERLAY, tier, true, GTQTUtil.collectorTankSizeFunction);
        this.tankSize = 16000;
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        GTQTTextures.DRYER_OVERLAY.renderOrientedState(renderState, translation, pipeline, this.getFrontFacing(), this.isActive(), true);
