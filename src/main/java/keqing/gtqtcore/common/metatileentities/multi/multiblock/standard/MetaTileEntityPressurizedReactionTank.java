...
public class MetaTileEntityPressurizedReactionTank extends RecipeMapMultiblockController implements IProgressBarMultiblock {

    int[] steam = new int[3];
    FluidStack STEAM = Steam.getFluid(1000);

    public MetaTileEntityPressurizedReactionTank(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTQTcoreRecipeMaps.PRESSURIZED_REACTION);
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MetaTileEntityPressurizedReactionTank(metaTileEntityId);
    }
