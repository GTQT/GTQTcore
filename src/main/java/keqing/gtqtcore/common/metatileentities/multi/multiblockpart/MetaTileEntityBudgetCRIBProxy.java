...
public class MetaTileEntityBudgetCRIBProxy extends MetaTileEntityMultiblockNotifiablePart
    ...
    public void addToMultiBlock(MultiblockControllerBase controllerBase) {
        ...
        if (hasMain()) {
            GTQTUtil.addNotifiableToMTE(getMain().getPatternItems(), controllerBase, this, false);
        }
    }
    ...
    public void removeFromMultiBlock(MultiblockControllerBase controllerBase) {
        ...
        if (hasMain()) {
            GTQTUtil.removeNotifiableFromMTE(getMain().getPatternItems(), controllerBase);
        }
    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        GTQTTextures.CRIB_PROXY.renderSided(getFrontFacing(), renderState, translation, pipeline);
    }
    ...
    private void tryToSetMain() {
        ...
        if (controllerBase != null) {
            ...
            GTQTUtil.addNotifiableToMTE(mainCRIBPatternItems, controllerBase, this, false);
    ...
    public boolean onDataStickRightClick(EntityPlayer player, ItemStack dataStick) {
        ...
        player.sendStatusMessage(new TextComponentTranslation("gtqtcore.machine.budget_crib_proxy.data_stick_use",
