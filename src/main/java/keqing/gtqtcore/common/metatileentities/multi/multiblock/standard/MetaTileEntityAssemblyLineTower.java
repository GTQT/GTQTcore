...
public class MetaTileEntityAssemblyLineTower extends RecipeMapMultiblockController {
    ...
    public MetaTileEntityAssemblyLineTower(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.ASSEMBLY_LINE_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityAssemblyLineTower(metaTileEntityId);
    }
