...
public class MetaTileEntitySuperInputBus extends MetaTileEntityMultiblockNotifiablePart
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        extraWidgets.addWidget(new ImageWidget(0, 0, 18 * 4, 20, GuiTextures.DISPLAY)
                .setTooltip("gtqtcore.machine.super_input_bus.slot_limit"));
        ...
        extraWidgets.addWidget(new ToggleButtonWidget(18 * 8, 0, 18, 18, GuiTextures.BUTTON_ITEM_OUTPUT,
                ...
                .setTooltipText("gtqtcore.machine.super_input_bus.return_items.button")
                .shouldUseBaseBackground());
    ...
    public boolean onScrewdriverClick(EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
        ...
        if (shouldReturnItems()) {
            ...
            playerIn.sendStatusMessage(
                    new TextComponentTranslation("gtqtcore.machine.super_input_bus.return_items.screwdriver.disabled"),
                    true);
        } else {
            setReturningItems(true);
            playerIn.sendStatusMessage(
                    new TextComponentTranslation("gtqtcore.machine.super_input_bus.return_items.screwdriver.enabled"),
                    true);
        }
    ...
    public void addToolUsages(ItemStack stack, World world, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtqtcore.machine.super_input_bus.screwdriver"));
        tooltip.add(I18n.format("gtqtcore.machine.super_input_bus.soft_mallet"));
