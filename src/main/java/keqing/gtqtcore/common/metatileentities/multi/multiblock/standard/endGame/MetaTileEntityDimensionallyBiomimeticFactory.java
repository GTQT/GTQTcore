...
public class MetaTileEntityDimensionallyBiomimeticFactory extends RecipeMapMultiblockController implements IBloomEffect, IFastRenderMetaTileEntity {
    ...
    private IBlockState getCasingState3() {
        return GTQTMetaBlocks.blockQuantumCasing.getState(BlockQuantumCasing.CasingType.DIMENSIONAL_BRIDGE_CASING);
    }

    private IBlockState getCasingState4() {
        return GTQTMetaBlocks.blockQuantumCasing.getState(BlockQuantumCasing.CasingType.SPACETIME_CASING);
    }

    private IBlockState getCasingState5() {
        return GTQTMetaBlocks.blockQuantumCasing.getState(BlockQuantumCasing.CasingType.ANNIHILATION_CASING);
    }
