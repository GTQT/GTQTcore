...
public class MetaTileEntityIndustrialChemicalReactor extends GTQTMultiblockCore {

    public MetaTileEntityIndustrialChemicalReactor(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{RecipeMaps.CHEMICAL_RECIPES, GTQTcoreRecipeMaps.POLYMERIZATION_RECIPES});
    }
