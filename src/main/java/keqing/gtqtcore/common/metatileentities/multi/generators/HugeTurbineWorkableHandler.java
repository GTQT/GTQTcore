...
public class HugeTurbineWorkableHandler extends MultiblockFuelRecipeLogic {

    private final int BASE_EU_OUTPUT;

    private int excessVoltage;

    public HugeTurbineWorkableHandler(RecipeMapMultiblockController metaTileEntity, int tier) {
    ...
    public long getMaxVoltage() {
        IRotorHolder rotorHolder = ((MetaTileEntityHugeTurbine) metaTileEntity).getRotorHolder();
