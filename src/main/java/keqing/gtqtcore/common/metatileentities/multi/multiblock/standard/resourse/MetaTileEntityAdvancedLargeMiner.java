package keqing.gtqtcore.common.metatileentities.multi.multiblock.standard.resourse;
...
public class MetaTileEntityAdvancedLargeMiner extends MultiblockWithDisplayBase implements IMiner, IControllable, IDataInfoProvider {
    ...
    public IBlockState getCasingState() {
        if (this.material.equals(Materials.Naquadah)) {
            ...
            return this.material.equals(Orichalcum) ? GTQTMetaBlocks.TURBINE_CASING1.getState(GTQTTurbineCasing1.TurbineCasingType.ST_TURBINE_CASING) :
                    GTQTMetaBlocks.TURBINE_CASING1.getState(GTQTTurbineCasing1.TurbineCasingType.AD_TURBINE_CASING);
        }
    }
