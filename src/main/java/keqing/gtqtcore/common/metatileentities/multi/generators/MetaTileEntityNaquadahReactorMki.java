...
public class MetaTileEntityNaquadahReactorMki extends FuelMultiblockController {
    ...
    public MetaTileEntityNaquadahReactorMki(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityNaquadahReactorMki(metaTileEntityId, tier);
    }
    ...
    private static class TurbineCombustionEngineWorkableHandler extends MultiblockFuelRecipeLogic {
        ...
        private final MetaTileEntityNaquadahReactorMki combustionEngine;
        private final boolean isExtreme;
        private final int tier;
        ...
        public TurbineCombustionEngineWorkableHandler(RecipeMapMultiblockController tileEntity, boolean isExtreme) {
            super(tileEntity);
            this.combustionEngine = (MetaTileEntityNaquadahReactorMki) tileEntity;
