package keqing.gtqtcore.common.metatileentities.multi.multiblockpart.appeng;
...
public class MetaTileEntityMECraftingIOBuffer extends MetaTileEntityAEHostablePart<IAEItemStack>
    ...
    public MetaTileEntityMECraftingIOBuffer(ResourceLocation metaTileEntityId) {
        this(metaTileEntityId, GTValues.EV);
    }

    protected MetaTileEntityMECraftingIOBuffer(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MetaTileEntityMECraftingIOBuffer(metaTileEntityId);
    }
