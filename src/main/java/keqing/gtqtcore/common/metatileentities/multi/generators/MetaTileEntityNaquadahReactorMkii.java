...
public class MetaTileEntityNaquadahReactorMkii extends FuelMultiblockController {
    ...
    public MetaTileEntityNaquadahReactorMkii(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityNaquadahReactorMkii(metaTileEntityId, tier);
    }
    ...
    private static class TurbineCombustionEngineWorkableHandler extends MultiblockFuelRecipeLogic {
        ...
        private final MetaTileEntityNaquadahReactorMkii combustionEngine;
        private final boolean isExtreme;
        private final int tier;
        ...
        public TurbineCombustionEngineWorkableHandler(RecipeMapMultiblockController tileEntity, boolean isExtreme) {
            super(tileEntity);
            this.combustionEngine = (MetaTileEntityNaquadahReactorMkii) tileEntity;
