...
public class MetaTileEntityKQHPCA extends MultiblockWithDisplayBase
    ...
    public MetaTileEntityKQHPCA(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityKQHPCA(metaTileEntityId);
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .where('S', GTQTMetaTileEntities.KQHPCA, EnumFacing.SOUTH)
    ...
    public static class HPCAGridHandler {
        ...
        // for testing
        private final MetaTileEntityKQHPCA controller;
        ...
        public HPCAGridHandler(MetaTileEntityKQHPCA controller) {
