...
public class MetaTileEntityFluidizedBed extends RecipeMapMultiblockController implements IProgressBarMultiblock {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("A A    ", "BBBQQQQ", "ICBQ  Q", "BCBQ  Q", "BCBRRRR", "BCB TT ", "BCB TT ", "BCB TT ", "BCB TT ", "OCBTTTT", "OCB    ", "BBB    ")
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        if (Blocks.AIR != null) {
            builder = MultiblockShapeInfo.builder()
                    ...
                    .aisle("A A    ", "XBBQQQQ", "ICBQ  Q", "BCBQ  Q", "BCBRRRR", "BCB TT ", "BCB TT ", "BCB TT ", "BCB TT ", "OCBTTTT", "OCB    ", "BBB    ")
