...
public class MetaTileEntityADVDataBank extends MultiblockWithDisplayBase implements IControllable {
    ...
    public MetaTileEntityADVDataBank(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityADVDataBank(metaTileEntityId);
    }
    ...
    private static IBlockState getFrontState() {
        return GTQTMetaBlocks.KQCC.getState(GTQTKQCC.CasingType.ULTRA_POWER_CASING);
    }
