...
public class MetaTileEntityEFusionReactor extends RecipeMapMultiblockController
    ...
    public MetaTileEntityEFusionReactor(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, GTQTcoreRecipeMaps.EFUSION_RECIPES);
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityEFusionReactor(metaTileEntityId, tier);
    }
...
*/
    ...
    private static class FusionProgressSupplier {
        ...
        private enum Type {
            ...
            public ProgressWidget getWidget(MetaTileEntityEFusionReactor instance) {
    ...
    private class FusionRecipeLogic extends MultiblockRecipeLogic {
        ...
        public FusionRecipeLogic(MetaTileEntityEFusionReactor tileEntity) {
            super(tileEntity);
        }
        ...
        protected void modifyOverclockPre(int  [] values,  IRecipePropertyStorage storage) {
            ...
            if (fusionTier != 0) fusionTier -= MetaTileEntityEFusionReactor.this.tier;
        ...
        protected void setActive(boolean active) {
            if (active != isActive) {
                MetaTileEntityEFusionReactor.this.progressBarSupplier.resetCountdown();
            }
...
/*
        RenderBufferHelper.renderRing(buffer,
                ...
                getPos().getY() - context.cameraY() + relativeBack.getYOffset() * 6 + 0.5,
