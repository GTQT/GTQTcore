...
import keqing.gtqtcore.common.block.blocks.GTQTKQCC;
...
public class MetaTileEntityADVNetworkSwitch extends MetaTileEntityADVDataBank implements IOpticalComputationProvider {
    ...
    public MetaTileEntityADVNetworkSwitch(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityADVNetworkSwitch(metaTileEntityId);
    }
    ...
    private static IBlockState getOuterState() {
        return GTQTMetaBlocks.KQCC.getState(GTQTKQCC.CasingType.ADV_COMPUTER_HEAT_VENT);
    }

    private static  IBlockState getCasingState() {
        return GTQTMetaBlocks.KQCC.getState(GTQTKQCC.CasingType.ADV_COMPUTER_CASING);
    }

    private static  IBlockState getAdvancedState() {
        return GTQTMetaBlocks.KQCC.getState(GTQTKQCC.CasingType.ULTRA_COMPUTER_CASING);
    }
