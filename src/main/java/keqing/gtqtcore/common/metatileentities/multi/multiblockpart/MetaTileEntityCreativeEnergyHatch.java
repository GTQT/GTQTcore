...
import keqing.gtqtcore.api.capability.impl.EnergyContainerCreative;
...
public class MetaTileEntityCreativeEnergyHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IEnergyContainer> {

    private final IEnergyContainer energyContainer;

    public MetaTileEntityCreativeEnergyHatch(ResourceLocation metaTileEntityId, int tier) {
