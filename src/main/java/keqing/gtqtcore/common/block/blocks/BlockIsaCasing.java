...
public class BlockIsaCasing extends VariantBlock<BlockIsaCasing.CasingType> {


    public BlockIsaCasing() {
        super(Material.IRON);
    ...
    public static enum CasingType implements IStringSerializable {
        ...
        ROUND("round"),
        SEPARATOR_ROTOR("separator_rotor"),
        IRIDIUM_TURBINE("iridium_turbine");
