...
public class BlockMultiblockGlass1 extends VariantBlock<BlockMultiblockGlass1.CasingType> {

    public BlockMultiblockGlass1() {
        super(Material.IRON);
        this.setTranslationKey("multiblock_glass1");
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag advanced) {
        ...
        VariantItemBlock itemBlock = (VariantItemBlock<BlockMultiblockGlass1.CasingType, BlockMultiblockGlass1>) stack.getItem();
        IBlockState stackState = itemBlock.getBlockState(stack);
        BlockMultiblockGlass1.CasingType casingType =  this.getState(stackState);
    ...
    public enum CasingType implements IStringSerializable, ITierGlassBlockState {
        ...
        SILICATE_GLASS("boron_silicate_glass", GTValues.MV, true),
        THY_SILICATE_GLASS("thy_boron_silicate_glass", GTValues.HV, true),
