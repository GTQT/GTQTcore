...
public class BlockMultiblockCasing2 extends VariantBlock<BlockMultiblockCasing2.CasingType> {

    public BlockMultiblockCasing2() {
        super(Material.IRON);
        setTranslationKey("multiblock_casing2");
        setHardness(5.0f);
        setResistance(10.0f);
