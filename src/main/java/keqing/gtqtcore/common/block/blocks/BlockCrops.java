...
public class BlockCrops extends net.minecraft.block.BlockCrops {
    ...
    public static List<BlockCrops> CROP_BLOCKS = new ArrayList<>();
    private String name;

    protected BlockCrops(String name, int age) {
    ...
    protected BlockCrops(String name) {
        this(name, 5);
    }

    public static BlockCrops create(String name) {
        AGE_TEMP = PropertyInteger.create("age", 0, 5);
        return new BlockCrops(name);
    }
