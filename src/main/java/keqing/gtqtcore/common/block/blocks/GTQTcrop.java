...
public class GTQTcrop extends BlockCrops {
    ...
    public static List<GTQTcrop> CROP_BLOCKS = new ArrayList<>();
    private String name;

    protected GTQTcrop(String name, int age) {
        ...
        this.setRegistryName("gtqtcore", "crop_" + name);
        CROP_BLOCKS.add(this);
        this.name = name;
        this.setTranslationKey("gtqt_crop_" + name);
    }

    protected GTQTcrop(String name) {
        this(name, 5);
    }

    public static GTQTcrop create(String name) {
        AGE_TEMP = PropertyInteger.create("age", 0, 5);
        return new GTQTcrop(name);
    }
