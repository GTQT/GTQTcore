...
public class BlockMultiblockCasing4 extends VariantBlock<BlockMultiblockCasing4.TurbineCasingType> {

    public BlockMultiblockCasing4() {
        super(Material.IRON);
        setTranslationKey("multiblock_casing4");
        setHardness(5.0f);
        setResistance(10.0f);
