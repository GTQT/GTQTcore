...
public class BlockElectrolyticBath extends VariantBlock<BlockElectrolyticBath.CasingType> {


    public BlockElectrolyticBath() {
        super(Material.IRON);
        this.setTranslationKey("electrolytic_bath");
