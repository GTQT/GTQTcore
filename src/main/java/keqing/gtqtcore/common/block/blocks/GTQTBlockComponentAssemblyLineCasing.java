...
public class GTQTBlockComponentAssemblyLineCasing extends VariantBlock<GTQTBlockComponentAssemblyLineCasing.CasingTier> {
    public GTQTBlockComponentAssemblyLineCasing() {
        super(Material.IRON);
