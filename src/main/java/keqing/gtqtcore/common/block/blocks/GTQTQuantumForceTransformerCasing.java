...
public class GTQTQuantumForceTransformerCasing extends VariantBlock<GTQTQuantumForceTransformerCasing.CasingType> {

    public GTQTQuantumForceTransformerCasing() {
        super(Material.IRON);
