...
public class BlockMultiblockCasing5 extends VariantBlock<BlockMultiblockCasing5.TurbineCasingType> {

    public BlockMultiblockCasing5() {
        super(Material.IRON);
        setTranslationKey("multiblock_casing5");
        setHardness(5.0f);
        setResistance(10.0f);
