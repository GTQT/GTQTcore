...
import keqing.gtqtcore.api.capability.impl.CWElectricityData;
import keqing.gtqtcore.api.utils.GCColorUtil;
import keqing.gtqtcore.api.utils.GTQTLangUtil;
import keqing.gtqtcore.api.utils.GTQTUtil;
import keqing.gtqtcore.client.gui.TooltipData;
import keqing.gtqtcore.client.gui.component.*;
import keqing.gtqtcore.client.gui.proup.ChannelLabelGroup;
import keqing.gtqtcore.client.gui.proup.IntModeGroup;
import keqing.gtqtcore.common.data.CWDataType;
import keqing.gtqtcore.common.data.CrossWorldDataHandler;
import keqing.gtqtcore.common.data.ElectricityData;
...
public class MemoryCardBehavior implements IItemBehaviour, ItemUIFactory {
    ...
    public ModularUI createUI(PlayerInventoryHolder playerInventoryHolder, EntityPlayer entityPlayer) {
        ...
        var canEdit = GTQTUtil.isOP(entityPlayer) || entityPlayer.isCreative();
        ...
        group.addWidget(new TextFieldWidget(5+25,10,70,20,true,
                        ...
                        .setValidator(GTQTLangUtil.hexIntValidator)
                ,0);
