...
public class CoverDualCover extends CoverBase implements CoverWithUI, ITickable, IControllable {
    ...
    public CoverDualCover( CoverDefinition definition,  CoverableView coverableView,
                           EnumFacing attachedSide, int tier, int itemsPerSecond, int mbPerTick) {
    ...
    @Override
    public void readCustomData(int discriminator,  PacketBuffer buf) {
    ...
    @Override
    public  EnumActionResult onScrewdriverClick( EntityPlayer playerIn,  EnumHand hand,
