...
import keqing.gtqtcore.client.widgets.PhantomDualWidget;
import keqing.gtqtcore.client.widgets.WidgetGroupLevelEmitter;
...
public class MEMachineController extends AbstractMeMachineController implements IStackWatcherHost {
    ...
    public void renderCover(@NotNull CCRenderState renderState, @NotNull Matrix4 translation, IVertexOperation[] pipeline, @NotNull Cuboid6 plateBox, @NotNull BlockRenderLayer layer) {
        SimpleOverlayRenderer overlay = this.enabled ? GTQTTextures.ME_MACHINE_CONTROLLER_ON : GTQTTextures.ME_MACHINE_CONTROLLER_OFF;
    ...
    public void readInitialSyncData(@NotNull PacketBuffer packetBuffer) {
        ...
        try {
            ...
            GTQTLog.logger.error("Could not read initial sync data", e);
        }
    }
